...
_str_main+=__indent() +'#    ____  _____   _         ____  _____' + '\n';
_str_main+=__indent() +'#   | __ )|  ___| (_)_ __   | __ )|  ___|' + '\n';
_str_main+=__indent() +'#   |  _ \\| |_    | | \'_ \\  |  _ \\| |_' + '\n';
_str_main+=__indent() +'#   | |_) |  _|   | | | | | | |_) |  _|' + '\n';
_str_main+=__indent() +'#   |____/|_|     |_|_| |_| |____/|_|' + '\n';
_str_main+=__indent() +'#' + '\n';
_str_main+=__indent() +'# bf in bf : by using bf assembler language' + '\n';
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# declare global variables' + '\n';
_str_main+=__indent() +'var bfData*' + (MAXDATA) + '' + '\n';
_str_main+=__indent() +'var bfCode*' + (MAXCODE) + '' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# read the BF code (stop when meet \'!\')' + '\n';
_str_main+=__indent() +'push 1' + '\n';
_str_main+=__indent() +'sbm loopCounter' + '\n';
...
_str_main+=__indent() +'push readchar' + '\n';
_str_main+=__indent() +'sub 42        # bf code - 42 , to have smaller value to compare during BF code interpretation' + '\n';
_str_main+=__indent() +'pop bfCode' + '\n';
_str_main+=__indent() +'arotl bfCode    # store readchar in bfCode' + '\n';
__blockLevel__--;
...
__blockLevel__--;
_str_main+=__indent() +'wend # loop for each input bf code' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# rewind bfCode' + '\n';
...
_str_main+=__indent() +'push bfCode.pos' + '\n';
_str_main+=__indent() +'loop' + '\n';
__blockLevel__++;
_str_main+=__indent() +'arotr bfCode' + '\n';
__blockLevel__--;
_str_main+=__indent() +'endloop' + '\n';
__blockLevel__--;
_str_main+=__indent() +'else # forward rot to zero' + '\n';
__blockLevel__++;
...
_str_main+=__indent() +'loop' + '\n';
__blockLevel__++;
_str_main+=__indent() +'arotl bfCode' + '\n';
__blockLevel__--;
_str_main+=__indent() +'endloop' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# interpret the BF code' + '\n';
_str_main+=__indent() +'push 1' + '\n';
_str_main+=__indent() +'sbm loopCounter2' + '\n';
_str_main+=__indent() +'while' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)scope_begin()' + '\n';
_str_main+=scope_begin();
_str_main+=__indent() +'#(end macro)scope_begin()' + '\n';
_str_main+=__indent() +'# local variables' + '\n';
...
_str_main+=__indent() +'arotl bfData' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
_str_main+=__indent() +'' + '\n';
...
_str_main+=__indent() +'arotr bfData' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)scope_begin()' + '\n';
...
_str_main+=__indent() +'push 1' + '\n';
_str_main+=__indent() +'sbm g2mcbl # Go To Matching Closing Bracket Loop' + '\n';
_str_main+=__indent() +'while' + '\n';
__blockLevel__++;
_str_main+=__indent() +'arotl   bfCode   # go to next bfCode' + '\n';
_str_main+=__indent() +'#(begin macro)scope_begin()' + '\n';
_str_main+=scope_begin();
_str_main+=__indent() +'#(end macro)scope_begin()' + '\n';
...
__blockLevel__--;
_str_main+=__indent() +'else       # if current bfCode != \'[\'' + '\n';
__blockLevel__++;
...
__blockLevel__--;
_str_main+=__indent() +'else # if countBracket >0 then countBracket--' + '\n';
__blockLevel__++;
...
_str_main+=__indent() +'push 1' + '\n';
_str_main+=__indent() +'sbm g2mobl # go to matching open bracket loop' + '\n';
_str_main+=__indent() +'while' + '\n';
__blockLevel__++;
_str_main+=__indent() +'arotr bfCode    # go to previous bfCode' + '\n';
_str_main+=__indent() +'#(begin macro)scope_begin()' + '\n';
_str_main+=scope_begin();
_str_main+=__indent() +'#(end macro)scope_begin()' + '\n';
_str_main+=__indent() +'#(begin macro)lvar("tmpBfCode","bfCode") # local variable in scope' + '\n';
...
__blockLevel__--;
_str_main+=__indent() +'else # if count bracket > 0 then countBracket --' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)at_dec("countBracket")' + '\n';
_str_main+=at_dec("countBracket");
_str_main+=__indent() +'#(end macro)at_dec("countBracket")' + '\n';
...
_str_main+=__indent() +'arotl   bfCode' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# destroy local variable' + '\n';
_str_main+=__indent() +'#(begin macro)scope_end()' + '\n';
_str_main+=scope_end();
_str_main+=__indent() +'#(end macro)scope_end()' + '\n';
__blockLevel__--;
