...
_str_main+=__indent() +'#    ____        _         ____    _   _                ____  _        _ #@(main@1)'+ __context() + '\n';
_str_main+=__indent() +'#   | __ ) _   _| |_ ___  |___ \\  | | | | _____  ____ _/ ___|| |_ _ __(_)_ __   __ _ #@(main@2)'+ __context() + '\n';
_str_main+=__indent() +'#   |  _ \\| | | | __/ _ \\   __) | | |_| |/ _ \\ \\/ / _` \\___ \\| __| \'__| | \'_ \\ / _` | #@(main@3)'+ __context() + '\n';
_str_main+=__indent() +'#   | |_) | |_| | ||  __/  / __/  |  _  |  __/>  < (_| |___) | |_| |  | | | | | (_| | #@(main@4)'+ __context() + '\n';
_str_main+=__indent() +'#   |____/ \\__, |\\__\\___| |_____| |_| |_|\\___/_/\\_\\__,_|____/ \\__|_|  |_|_| |_|\\__, | #@(main@5)'+ __context() + '\n';
_str_main+=__indent() +'#          |___/                                                               |___/ #@(main@6)'+ __context() + '\n';
_str_main+=__indent() +'# Read input byte and output it as hexa string #@(main@7)'+ __context() + '\n';
...
whIdx++;
_strwriteHexa+=__indent() +'sbm _input' + (whIdx) + ' #@(main@17)'+ __context() + '\n';
...
__blockLevel__--;
_strwriteHexa+=__indent() +'else #@(main@20)'+ __context() + '\n';
__blockLevel__++;
...
__blockLevel__--;
_strwriteHexa+=__indent() +'fi #@(main@22)'+ __context() + '\n';
_strwriteHexa+=__indent() +'pop out #@(main@23)'+ __context() + '\n';
return _strwriteHexa;
}
_str_main+=__indent() +' #@(main@25)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@26)'+ __context() + '\n';
_str_main+=__indent() +'push    1 #@(main@27)'+ __context() + '\n';
_str_main+=__indent() +'while #@(main@28)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'push    in #@(main@29)'+ __context() + '\n';
_str_main+=__indent() +'push    16 #@(main@30)'+ __context() + '\n';
_str_main+=__indent() +'div #@(main@31)'+ __context() + '\n';
...
__blockLevel__--;
_str_main+=__indent() +'wend #@(main@34)'+ __context() + '\n';
return _str_main;
}
_main();
