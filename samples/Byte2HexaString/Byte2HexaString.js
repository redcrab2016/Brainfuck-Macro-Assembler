...
_str_main+=__indent() +'#    ____        _         ____    _   _                ____  _        _' + '\n';
_str_main+=__indent() +'#   | __ ) _   _| |_ ___  |___ \\  | | | | _____  ____ _/ ___|| |_ _ __(_)_ __   __ _' + '\n';
_str_main+=__indent() +'#   |  _ \\| | | | __/ _ \\   __) | | |_| |/ _ \\ \\/ / _` \\___ \\| __| \'__| | \'_ \\ / _` |' + '\n';
_str_main+=__indent() +'#   | |_) | |_| | ||  __/  / __/  |  _  |  __/>  < (_| |___) | |_| |  | | | | | (_| |' + '\n';
_str_main+=__indent() +'#   |____/ \\__, |\\__\\___| |_____| |_| |_|\\___/_/\\_\\__,_|____/ \\__|_|  |_|_| |_|\\__, |' + '\n';
_str_main+=__indent() +'#          |___/                                                               |___/' + '\n';
_str_main+=__indent() +'# Read input byte and output it as hexa string' + '\n';
...
whIdx++;
_strwriteHexa+=__indent() +'sbm _input' + (whIdx) + '' + '\n';
_strwriteHexa+=__indent() +'#(begin macro)if_sup("_input" + whIdx,9)' + '\n';
_strwriteHexa+=if_sup("_input" + whIdx,9);
_strwriteHexa+=__indent() +'#(end macro)if_sup("_input" + whIdx,9)' + '\n';
_strwriteHexa+=__indent() +'#(begin macro)at_add("_input" + whIdx, "\'7\'")' + '\n';
_strwriteHexa+=at_add("_input" + whIdx, "'7'");
_strwriteHexa+=__indent() +'#(end macro)at_add("_input" + whIdx, "\'7\'")' + '\n';
__blockLevel__--;
_strwriteHexa+=__indent() +'else' + '\n';
__blockLevel__++;
_strwriteHexa+=__indent() +'#(begin macro)at_add("_input" + whIdx, "\'0\'")' + '\n';
_strwriteHexa+=at_add("_input" + whIdx, "'0'");
_strwriteHexa+=__indent() +'#(end macro)at_add("_input" + whIdx, "\'0\'")' + '\n';
__blockLevel__--;
_strwriteHexa+=__indent() +'fi' + '\n';
_strwriteHexa+=__indent() +'pop out' + '\n';
...
__blockLevel__++;
_str_main+=__indent() +'push    in' + '\n';
_str_main+=__indent() +'push    16' + '\n';
_str_main+=__indent() +'div' + '\n';
_str_main+=__indent() +'#(begin macro)writeHexa() # output most significant hexa character from head of stack value, then drop' + '\n';
_str_main+=writeHexa();
_str_main+=__indent() +'#(end macro)writeHexa() # output most significant hexa character from head of stack value, then drop' + '\n';
_str_main+=__indent() +'#(begin macro)writeHexa() # output less significant hexa character from head of stack value, then drop' + '\n';
_str_main+=writeHexa();
_str_main+=__indent() +'#(end macro)writeHexa() # output less significant hexa character from head of stack value, then drop' + '\n';
__blockLevel__--;
