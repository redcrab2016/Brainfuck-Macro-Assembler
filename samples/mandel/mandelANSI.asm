...
#                                                        
# ASCII (ANSI version)Mandelbrot Fixed point number example
...
ansi_SGR_fg_white
ansi_SGR_bold
print("ASCII Mandelbrot[ANSI] : fixed point number sample in "+ FP_I*8 +"." + FP_P*8+" bits format\n")
...
loop
    ...
    loop
        ...
        # else // outside mandel (ascii A to Z: iteration 0 to 26)
            ...
            add     52
            pop     i
            # ansi_SGR_bgRGB  i,  i,  196 # with i= i *8
            ansi_SGR_bg256  i 
            print(" ")
        fi
        # x++
