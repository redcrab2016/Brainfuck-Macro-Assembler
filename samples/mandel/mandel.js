...
_str_main+=__indent() +'# ASCII Mandelbrot Fixed point number example #@(main@1)'+ __context() + '\n';
_str_main+=__indent() +'# inspired by C code at https://stackoverflow.com/questions/16124127/improvement-to-my-mandelbrot-set-code #@(main@2)'+ __context() + '\n';
...
__context__.push('(fpnumber_inc@77)');
...
_str_main+=__indent() +' #@(fpnumber_inc@79)'+ __context() + '\n';
_str_main+=__indent() +'# macro pushFP(I,P,immValue) : push immediate fixed point number onto the stack #@(fpnumber_inc@80)'+ __context() + '\n';
...
__context__.push('(fpnumber_inc@82)');
...
_str_main+=__indent() +' #@(fpnumber_inc@85)'+ __context() + '\n';
_str_main+=__indent() +'# macro dropFP(I,P) : drop fixed point number from stack #@(fpnumber_inc@86)'+ __context() + '\n';
...
__context__.push('(fpnumber_inc@88)');
_strdropFP+=dropX(((isNaN(('' + ((I+P)) + '')*1))?('' + ((I+P)) + ''):(('' + ((I+P)) + '')*1)));
__context__.pop();
_strdropFP+=__indent() +'#(end macro)dropX   ' + ((I+P)) + '' + '\n';
return _strdropFP;
}
_str_main+=__indent() +' #@(fpnumber_inc@90)'+ __context() + '\n';
_str_main+=__indent() +'# macro pushvFP(I,P,name) : push in stack the fixed point number contained variable \'name\' #@(fpnumber_inc@91)'+ __context() + '\n';
...
__context__.push('(fpnumber_inc@93)');
_strpushvFP+=pushvX(((isNaN(('' + ((I+P)) + '')*1))?('' + ((I+P)) + ''):(('' + ((I+P)) + '')*1)),((isNaN(('' + (name) + '')*1))?('' + (name) + ''):(('' + (name) + '')*1)));
__context__.pop();
_strpushvFP+=__indent() +'#(end macro)pushvX ' + ((I+P)) + ', ' + (name) + '' + '\n';
return _strpushvFP;
}
_str_main+=__indent() +' #@(fpnumber_inc@95)'+ __context() + '\n';
_str_main+=__indent() +'# macro popvFP(I,P,name) : pop the fixed point number from stack to store in variable \'name\' #@(fpnumber_inc@96)'+ __context() + '\n';
...
__context__.push('(fpnumber_inc@98)');
_strpopvFP+=popvX(((isNaN(('' + ((I+P)) + '')*1))?('' + ((I+P)) + ''):(('' + ((I+P)) + '')*1)),((isNaN(('' + (name) + '')*1))?('' + (name) + ''):(('' + (name) + '')*1)));
__context__.pop();
_strpopvFP+=__indent() +'#(end macro)popvX   ' + ((I+P)) + ',    ' + (name) + '' + '\n';
return _strpopvFP;
}
_str_main+=__indent() +' #@(fpnumber_inc@100)'+ __context() + '\n';
_str_main+=__indent() +'# macro supFP(I,P) : push 1 if stack-1 > stack, push 0 otherwise #@(fpnumber_inc@101)'+ __context() + '\n';
var _supFP; _supFP=0;
...
__context__.push('(fpnumber_inc@103)');
_strsupFP+=supX(((isNaN(('' + ((I+P)) + '')*1))?('' + ((I+P)) + ''):(('' + ((I+P)) + '')*1)));
__context__.pop();
_strsupFP+=__indent() +'#(end macro)supX    ' + ((I+P)) + '' + '\n';
return _strsupFP;
}
_str_main+=__indent() +' #@(fpnumber_inc@105)'+ __context() + '\n';
_str_main+=__indent() +'# macro castFP(I1,P1,I2,P2) : transform head of Stack Fixed point number I1,P1 (I1+P1* 8 bits) into a Fixed point number I2,P2 (I2+P2*8 bits) #@(fpnumber_inc@106)'+ __context() + '\n';
...
__context__.push('(fpnumber_inc@110)');
...
_strcastFP+=__indent() +' #@(fpnumber_inc@112)'+ __context() + '\n';
_strcastFP+=__indent() +'#(begin macro)popvX   ' + (I1P1) + ', _castFPinstack' + (_castFP) + '' + '\n';
__context__.push('(fpnumber_inc@113)');
...
_strcastFP+=__indent() +'# reset outstack #@(fpnumber_inc@114)'+ __context() + '\n';
_strcastFP+=__indent() +'#(begin macro)setvX   ' + (I2P2) + ', _castFPoutstack' + (_castFP) + ',   0' + '\n';
__context__.push('(fpnumber_inc@115)');
...
_strcastFP+=__indent() +'# sign #@(fpnumber_inc@116)'+ __context() + '\n';
_strcastFP+=__indent() +'push    _castFPinstack' + (_castFP) + '_s #@(fpnumber_inc@117)'+ __context() + '\n';
_strcastFP+=__indent() +'pop     _castFPoutstack' + (_castFP) + '_s #@(fpnumber_inc@118)'+ __context() + '\n';
_strcastFP+=__indent() +'# integer part #@(fpnumber_inc@119)'+ __context() + '\n';
if (I1 >= I2) {
for (var xx = 0 ; xx < I2; xx++) {
_strcastFP+=__indent() +'push    _castFPinstack' + (_castFP) + '_' + ((xx + P1)) + ' #@(fpnumber_inc@122)'+ __context() + '\n';
_strcastFP+=__indent() +'pop     _castFPoutstack' + (_castFP) + '_' + ((xx + P2)) + ' #@(fpnumber_inc@123)'+ __context() + '\n';
}
} else { // I1 < I2
for (var xx = 0 ; xx < I1; xx++) {
_strcastFP+=__indent() +'push    _castFPinstack' + (_castFP) + '_' + ((xx + P1)) + ' #@(fpnumber_inc@127)'+ __context() + '\n';
_strcastFP+=__indent() +'pop     _castFPoutstack' + (_castFP) + '_' + ((xx + P2)) + ' #@(fpnumber_inc@128)'+ __context() + '\n';
}
}
_strcastFP+=__indent() +'# fract part #@(fpnumber_inc@131)'+ __context() + '\n';
if (P1 >= P2) {
for (var xx = 0 ; xx <P2; xx++) {
_strcastFP+=__indent() +'push    _castFPinstack' + (_castFP) + '_' + ((P1-xx-1)) + ' #@(fpnumber_inc@134)'+ __context() + '\n';
_strcastFP+=__indent() +'pop     _castFPoutstack' + (_castFP) + '_' + ((P2-xx-1)) + ' #@(fpnumber_inc@135)'+ __context() + '\n';
}
} else { // P1 < P2
for (var xx = 0 ; xx < P1; xx++) {
_strcastFP+=__indent() +'push    _castFPinstack' + (_castFP) + '_' + ((P1-xx-1)) + ' #@(fpnumber_inc@139)'+ __context() + '\n';
_strcastFP+=__indent() +'pop     _castFPoutstack' + (_castFP) + '_' + ((P2-xx-1)) + ' #@(fpnumber_inc@140)'+ __context() + '\n';
}
}
_strcastFP+=__indent() +'#(begin macro)pushvX  ' + (I2P2) + ', _castFPoutstack' + (_castFP) + '' + '\n';
__context__.push('(fpnumber_inc@143)');
...
_str_main+=__indent() +' #@(fpnumber_inc@145)'+ __context() + '\n';
_str_main+=__indent() +'# macro integerFP(I,P) : transform head of stack fixed point number I,P (I+P)*8 bits , into a signed integer I*8bits #@(fpnumber_inc@146)'+ __context() + '\n';
...
__context__.push('(fpnumber_inc@148)');
_strintegerFP+=castFP(I,P,I,0);
__context__.pop();
_strintegerFP+=__indent() +'#(end macro)castFP(I,P,I,0)' + '\n';
return _strintegerFP;
}
_str_main+=__indent() +' #@(fpnumber_inc@150)'+ __context() + '\n';
_str_main+=__indent() +'# macro fract(I,P) : retrieve the fractional part of head of stack fixed point number I,P (I+P)*8 bits, into a signed integer P*8 bits #@(fpnumber_inc@151)'+ __context() + '\n';
var _fract; _fract=0;
...
__context__.push('(fpnumber_inc@153)');
_strfract+=castFP(I,P,0,P);
__context__.pop();
_strfract+=__indent() +'#(end macro)castFP(I,P,0,P)' + '\n';
return _strfract;
}
_str_main+=__indent() +' #@(fpnumber_inc@155)'+ __context() + '\n';
_str_main+=__indent() +'# macro mul 2 fixed point number (I+P)*8 bits in stack #@(fpnumber_inc@156)'+ __context() + '\n';
var _mulFP; _mulFP=0;
...
__context__.push('(fpnumber_inc@160)');
...
_strmulFP+=__indent() +' #@(fpnumber_inc@166)'+ __context() + '\n';
_strmulFP+=__indent() +'# upcast nameA to nameAX (from I+P to (I+P) * 2) #@(fpnumber_inc@167)'+ __context() + '\n';
_strmulFP+=__indent() +'#(begin macro)pushvX  ' + (IP) + ',   _mulFPnameA' + (_mulFP) + '' + '\n';
__context__.push('(fpnumber_inc@168)');
...
_strmulFP+=__indent() +' #@(fpnumber_inc@171)'+ __context() + '\n';
_strmulFP+=__indent() +'# upcast nameB to nameBX (from I+P to (I+P) * 2) #@(fpnumber_inc@172)'+ __context() + '\n';
_strmulFP+=__indent() +'#(begin macro)pushvX  ' + (IP) + ',   _mulFPnameB' + (_mulFP) + '' + '\n';
__context__.push('(fpnumber_inc@173)');
...
_strmulFP+=__indent() +' #@(fpnumber_inc@178)'+ __context() + '\n';
_strmulFP+=__indent() +'#(begin macro)pushvX  ' + (IP2) + ',  _mulFPresultX' + (_mulFP) + '' + '\n';
__context__.push('(fpnumber_inc@179)');
...
_str_main+=__indent() +' #@(fpnumber_inc@185)'+ __context() + '\n';
_str_main+=__indent() +'#(end include)../include/fpnumber.inc' + '\n';
_str_main+=__indent() +' #@(main@5)'+ __context() + '\n';
_str_main+=__indent() +'# 8.24 fixed number FP_I=1*8 bits , FP_P=3*8 bits #@(main@6)'+ __context() + '\n';
_str_main+=__indent() +'## 8 = 1*8 bits : for integer part #@(main@7)'+ __context() + '\n';
var FP_I;FP_I='1'; FP_I=(isNaN(FP_I*1))?(FP_I):(FP_I*1); 
_str_main+=__indent() +'## 24 = 3*8 bits  : for fractional part #@(main@9)'+ __context() + '\n';
...
_str_main+=__indent() +'var     i #@(main@33)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@34)'+ __context() + '\n';
_str_main+=__indent() +'#declareTmpX ' + (FP) + ' #@(main@35)'+ __context() + '\n';
_str_main+=__indent() +'#declareTmpX ' + (FP*2) + ' #@(main@36)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@37)'+ __context() + '\n';
...
_str_main+=__indent() +'push    ' + (H) + ' #@(main@40)'+ __context() + '\n';
_str_main+=__indent() +'loop #@(main@41)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'push    ' + (W) + ' #@(main@42)'+ __context() + '\n';
_str_main+=__indent() +'loop #@(main@43)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'# pr = 1.5 *(x - halfW) * oneOnHalfZoomW + moveX #@(main@44)'+ __context() + '\n';
_str_main+=__indent() +'#(begin macro)pushFP  ' + (FP_I) + ', ' + (FP_P) + ', 1.5' + '\n';
__context__.push('(main@45)');
_str_main+=pushFP(((isNaN(('' + (FP_I) + '')*1))?('' + (FP_I) + ''):(('' + (FP_I) + '')*1)),((isNaN(('' + (FP_P) + '')*1))?('' + (FP_P) + ''):(('' + (FP_P) + '')*1)),((isNaN(('1.5')*1))?('1.5'):(('1.5')*1)));
__context__.pop();
...
_str_main+=__indent() +'# pi = (y - halfH) * oneOnHalfZoomH + moveY #@(main@55)'+ __context() + '\n';
...
_str_main+=__indent() +'# newRe = 0 #@(main@64)'+ __context() + '\n';
...
_str_main+=__indent() +'# newIm = 0 #@(main@66)'+ __context() + '\n';
...
_str_main+=__indent() +'# oldRe = 0 #@(main@68)'+ __context() + '\n';
...
_str_main+=__indent() +'# oldIm = 0 #@(main@70)'+ __context() + '\n';
...
_str_main+=__indent() +'# i = 0 #@(main@72)'+ __context() + '\n';
...
_str_main+=__indent() +'# for (i =0 ; i < maxIte; i++) { #@(main@74)'+ __context() + '\n';
_str_main+=__indent() +'push    1 #@(main@75)'+ __context() + '\n';
_str_main+=__indent() +'sbm     loop #@(main@76)'+ __context() + '\n';
_str_main+=__indent() +'while #@(main@77)'+ __context() + '\n';
__blockLevel__++;
...
_str_main+=__indent() +'#    oldRe = newRe #@(main@79)'+ __context() + '\n';
...
_str_main+=__indent() +'#    oldIm = newIm #@(main@81)'+ __context() + '\n';
...
_str_main+=__indent() +'#    newRe = oldRe * oldRe - oldIm * oldIm + pr #@(main@83)'+ __context() + '\n';
...
_str_main+=__indent() +'#    newIm = 2 * oldRe * oldIm + pi #@(main@94)'+ __context() + '\n';
...
_str_main+=__indent() +'#    if (newRe *  newRe +  newIm * newIm) > 4 break for #@(main@103)'+ __context() + '\n';
_str_main+=__indent() +'## newRe *  newRe +  newIm * newIm #@(main@104)'+ __context() + '\n';
...
__context__.pop();
_str_main+=__indent() +'#(end macro)addFP   ' + (FP_I) + ', ' + (FP_P) + '' + '\n';
_str_main+=__indent() +'## if stack FP > 4 break #@(main@112)'+ __context() + '\n';
...
_str_main+=__indent() +'if #@(main@115)'+ __context() + '\n';
__blockLevel__++;
...
__blockLevel__--;
_str_main+=__indent() +'fi #@(main@119)'+ __context() + '\n';
__blockLevel__--;
_str_main+=__indent() +'else #@(main@120)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)at_reset    loop' + '\n';
...
_str_main+=__indent() +'# } #@(main@123)'+ __context() + '\n';
__blockLevel__--;
_str_main+=__indent() +'wend #@(main@124)'+ __context() + '\n';
_str_main+=__indent() +'# if (i >= maxIte) black point (inside mandel) #@(main@125)'+ __context() + '\n';
...
_str_main+=__indent() +'# else // outside mandel (ascii A to Y: iteration 0 to 25) #@(main@128)'+ __context() + '\n';
__blockLevel__--;
_str_main+=__indent() +'else #@(main@129)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'push    i #@(main@130)'+ __context() + '\n';
_str_main+=__indent() +'add     65 #@(main@131)'+ __context() + '\n';
_str_main+=__indent() +'out #@(main@132)'+ __context() + '\n';
_str_main+=__indent() +'drop #@(main@133)'+ __context() + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi #@(main@134)'+ __context() + '\n';
_str_main+=__indent() +'# x++ #@(main@135)'+ __context() + '\n';
...
_str_main+=__indent() +'# x = 0 #@(main@138)'+ __context() + '\n';
...
_str_main+=__indent() +'# y++ #@(main@140)'+ __context() + '\n';
...
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'endloop #@(main@143)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@144)'+ __context() + '\n';
return _str_main;
}
_main();
