...
_str_main+=__indent() +'# ASCII Mandelbrot Fixed point number example #@(main@11)'+ __context() + '\n';
...
_str_main+=__indent() +' #@(main@15)'+ __context() + '\n';
_str_main+=__indent() +'# 8.24 fixed number FP_I=1*8 bits , FP_P=3*8 bits #@(main@16)'+ __context() + '\n';
_str_main+=__indent() +'## 8 = 1*8 bits : for integer part #@(main@17)'+ __context() + '\n';
var FP_I;FP_I='1'; FP_I=(isNaN(FP_I*1))?(FP_I):(FP_I*1); 
_str_main+=__indent() +'## 24 = 3*8 bits  : for fractional part #@(main@19)'+ __context() + '\n';
var FP_P;FP_P='3'; FP_P=(isNaN(FP_P*1))?(FP_P):(FP_P*1); 
var FP;FP='' + ((FP_I+FP_P)) + ''; FP=(isNaN(FP*1))?(FP):(FP*1); 
...
_str_main+=__indent() +'#declareTmpX ' + (FP) + ' #@(main@45)'+ __context() + '\n';
_str_main+=__indent() +'#declareTmpX ' + (FP*2) + ' #@(main@46)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@47)'+ __context() + '\n';
_str_main+=__indent() +'#(begin macro)print("ASCII Mandelbrot : fixed point number sample in "+ FP_I*8 +"." + FP_P*8+" bits format\\n")' + '\n';
__context__.push('(main@48)');
_str_main+=print("ASCII Mandelbrot : fixed point number sample in "+ FP_I*8 +"." + FP_P*8+" bits format\n");
__context__.pop();
_str_main+=__indent() +'#(end macro)print("ASCII Mandelbrot : fixed point number sample in "+ FP_I*8 +"." + FP_P*8+" bits format\\n")' + '\n';
...
_str_main+=__indent() +'push    ' + (H) + ' #@(main@50)'+ __context() + '\n';
_str_main+=__indent() +'loop #@(main@51)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'push    ' + (W) + ' #@(main@52)'+ __context() + '\n';
_str_main+=__indent() +'loop #@(main@53)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'# pr = (x - halfW) * oneOnHalfZoomW + moveX #@(main@54)'+ __context() + '\n';
_str_main+=__indent() +'#pushFP  ' + (FP_I) + ', ' + (FP_P) + ', 1.5 #@(main@55)'+ __context() + '\n';
...
_str_main+=__indent() +'#mulFP   ' + (FP_I) + ', ' + (FP_P) + ' #@(main@59)'+ __context() + '\n';
...
_str_main+=__indent() +'# pi = (y - halfH) * oneOnHalfZoomH + moveY #@(main@65)'+ __context() + '\n';
...
_str_main+=__indent() +'# newRe = 0 #@(main@74)'+ __context() + '\n';
...
_str_main+=__indent() +'# newIm = 0 #@(main@76)'+ __context() + '\n';
...
_str_main+=__indent() +'# oldRe = 0 #@(main@78)'+ __context() + '\n';
...
_str_main+=__indent() +'# oldIm = 0 #@(main@80)'+ __context() + '\n';
...
_str_main+=__indent() +'# i = 0 #@(main@82)'+ __context() + '\n';
...
_str_main+=__indent() +'# for (i =0 ; i < maxIte; i++) { #@(main@84)'+ __context() + '\n';
_str_main+=__indent() +'push    1 #@(main@85)'+ __context() + '\n';
_str_main+=__indent() +'sbm     loop #@(main@86)'+ __context() + '\n';
_str_main+=__indent() +'while #@(main@87)'+ __context() + '\n';
__blockLevel__++;
...
_str_main+=__indent() +'#    oldRe = newRe #@(main@89)'+ __context() + '\n';
...
_str_main+=__indent() +'#    oldIm = newIm #@(main@91)'+ __context() + '\n';
...
_str_main+=__indent() +'#    newRe = oldRe * oldRe - oldIm * oldIm + pr #@(main@93)'+ __context() + '\n';
...
_str_main+=__indent() +'#    newIm = 2 * oldRe * oldIm + pi #@(main@104)'+ __context() + '\n';
...
_str_main+=__indent() +'#    if (newRe *  newRe +  newIm * newIm) > 4 break for #@(main@113)'+ __context() + '\n';
_str_main+=__indent() +'## newRe *  newRe +  newIm * newIm #@(main@114)'+ __context() + '\n';
...
__context__.pop();
_str_main+=__indent() +'#(end macro)addFP   ' + (FP_I) + ', ' + (FP_P) + '' + '\n';
_str_main+=__indent() +'## if stack FP > 4 break #@(main@122)'+ __context() + '\n';
...
_str_main+=__indent() +'if #@(main@125)'+ __context() + '\n';
__blockLevel__++;
...
__blockLevel__--;
_str_main+=__indent() +'else #@(main@130)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)at_reset    loop' + '\n';
...
__blockLevel__--;
_str_main+=__indent() +'wend #@(main@134)'+ __context() + '\n';
_str_main+=__indent() +'# if (i >= maxIte) black point (inside mandel) #@(main@135)'+ __context() + '\n';
...
_str_main+=__indent() +'add     65 #@(main@141)'+ __context() + '\n';
_str_main+=__indent() +'out #@(main@142)'+ __context() + '\n';
_str_main+=__indent() +'drop #@(main@143)'+ __context() + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi #@(main@144)'+ __context() + '\n';
_str_main+=__indent() +'# x++ #@(main@145)'+ __context() + '\n';
...
__blockLevel__--;
_str_main+=__indent() +'endloop #@(main@147)'+ __context() + '\n';
_str_main+=__indent() +'# x = 0 #@(main@148)'+ __context() + '\n';
...
_str_main+=__indent() +'# y++ #@(main@150)'+ __context() + '\n';
...
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'endloop #@(main@153)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@154)'+ __context() + '\n';
return _str_main;
}
_main();
