...
_straddof+='#(js) _sv10++;' + '\n';
_sv10++;
_straddof+='    sbm _b' + _sv10 + '' + '\n';
_straddof+='    sbm _a' + _sv10 + ' - 1' + '\n';
_straddof+='#(begin macro)    scope_begin()' + '\n';
_straddof+=scope_begin();
_straddof+='#(end macro)    scope_begin()' + '\n';
_straddof+='#(begin macro)        lvar("_c"+_sv10,0)' + '\n';
_straddof+=lvar("_c"+_sv10,0);
_straddof+='#(end macro)        lvar("_c"+_sv10,0)' + '\n';
_straddof+='        push 1' + '\n';
_straddof+='        sbm _loopao' + _sv10 + '' + '\n';
_straddof+='        while' + '\n';
_straddof+='            push _a' + _sv10 + '' + '\n';
_straddof+='            if' + '\n';
_straddof+='                at _a' + _sv10 + '' + '\n';
_straddof+='                    dec' + '\n';
_straddof+='                ta ' + '\n';
_straddof+='                at _b' + _sv10 + '' + '\n';
_straddof+='                    inc' + '\n';
_straddof+='                ta' + '\n';
_straddof+='                push _b' + _sv10 + '' + '\n';
_straddof+='                not' + '\n';
_straddof+='                if ' + '\n';
_straddof+='                    at _c' + _sv10 + '' + '\n';
_straddof+='                        set 1' + '\n';
_straddof+='                    ta' + '\n';
_straddof+='                fi' + '\n';
_straddof+='            else ' + '\n';
_straddof+='                at _loopao' + _sv10 + '' + '\n';
_straddof+='                    reset' + '\n';
_straddof+='                ta' + '\n';
_straddof+='            fi' + '\n';
_straddof+='        wend' + '\n';
_straddof+='        push _c' + _sv10 + '' + '\n';
_straddof+='        if' + '\n';
_straddof+='            at _a' + _sv10 + '' + '\n';
_straddof+='                set 1' + '\n';
_straddof+='            ta' + '\n';
...
_strsubof+='#(js) _sv10++;' + '\n';
_sv10++;
_strsubof+='    sbm _b' + _sv10 + '' + '\n';
_strsubof+='    sbm _a' + _sv10 + ' - 1' + '\n';
_strsubof+='#(begin macro)    scope_begin()' + '\n';
_strsubof+=scope_begin();
_strsubof+='#(end macro)    scope_begin()' + '\n';
_strsubof+='#(begin macro)        lvar("_c"+_sv10,0)' + '\n';
_strsubof+=lvar("_c"+_sv10,0);
_strsubof+='#(end macro)        lvar("_c"+_sv10,0)' + '\n';
_strsubof+='        push 1' + '\n';
_strsubof+='        sbm _loopao' + _sv10 + '' + '\n';
_strsubof+='        while' + '\n';
_strsubof+='            push _b' + _sv10 + '' + '\n';
_strsubof+='            if  ' + '\n';
_strsubof+='                at _b' + _sv10 + '' + '\n';
_strsubof+='                    dec' + '\n';
_strsubof+='                ta' + '\n';
_strsubof+='                at _a' + _sv10 + '' + '\n';
_strsubof+='                    dec' + '\n';
_strsubof+='                ta' + '\n';
_strsubof+='                push _a' + _sv10 + '' + '\n';
_strsubof+='                inc' + '\n';
_strsubof+='                not' + '\n';
_strsubof+='                if' + '\n';
_strsubof+='                    at _c' + _sv10 + '' + '\n';
_strsubof+='                        set 1' + '\n';
_strsubof+='                    ta' + '\n';
_strsubof+='                fi ' + '\n';
_strsubof+='            else' + '\n';
_strsubof+='                at _loopao' + _sv10 + '' + '\n';
_strsubof+='                    reset' + '\n';
_strsubof+='                ta' + '\n';
_strsubof+='            fi' + '\n';
_strsubof+='        wend' + '\n';
_strsubof+='        push _c' + _sv10 + '' + '\n';
_strsubof+='        if' + '\n';
_strsubof+='            at _b' + _sv10 + '' + '\n';
_strsubof+='                set 1' + '\n';
_strsubof+='            ta' + '\n';
...
_straddvvvX+=scope_begin();
_straddvvvX+='#(end macro)        scope_begin()' + '\n';
_straddvvvX+='#(begin macro)            lvar("_asupb"+_sv3,0)  # by default absA is not sup to absB' + '\n';
_straddvvvX+=lvar("_asupb"+_sv3,0);
_straddvvvX+='#(end macro)            lvar("_asupb"+_sv3,0)  # by default absA is not sup to absB' + '\n';
_straddvvvX+='#(begin macro)            lvar("_aequb"+_sv3,0)  # by default absA is not equal to absB ' + '\n';
_straddvvvX+=lvar("_aequb"+_sv3,0);
_straddvvvX+='#(end macro)            lvar("_aequb"+_sv3,0)  # by default absA is not equal to absB ' + '\n';
...
_straddvvX+='#(begin macro)        lvarX(X,"addvvXnameB"+_sv11)' + '\n';
_straddvvX+=lvarX(X,"addvvXnameB"+_sv11);
_straddvvX+='#(end macro)        lvarX(X,"addvvXnameB"+_sv11)' + '\n';
_straddvvX+='#(begin macro)    pushvX(X,name)' + '\n';
_straddvvX+=pushvX(X,name);
_straddvvX+='#(end macro)    pushvX(X,name)' + '\n';
_straddvvX+='#(begin macro)    popvX(X,"addvvXnameB"+_sv11)' + '\n';
_straddvvX+=popvX(X,"addvvXnameB"+_sv11);
_straddvvX+='#(end macro)    popvX(X,"addvvXnameB"+_sv11)' + '\n';
_straddvvX+='#(begin macro)    addvvvX(X,name, "addvvXnameB"+_sv11, nameA)' + '\n';
_straddvvX+=addvvvX(X,name, "addvvXnameB"+_sv11, nameA);
_straddvvX+='#(end macro)    addvvvX(X,name, "addvvXnameB"+_sv11, nameA)' + '\n';
...
_straddvX+='#(js) var _xbits; _xbits = X * 8;' + '\n';
var _xbits; _xbits = X * 8;
_straddvX+='#(begin macro)    popvX(X,"__tmp" + _xbits + "__")' + '\n';
_straddvX+=popvX(X,"__tmp" + _xbits + "__");
_straddvX+='#(end macro)    popvX(X,"__tmp" + _xbits + "__")' + '\n';
_straddvX+='#(begin macro)    addvvX(X,"__tmp" + _xbits + "__",nameA)' + '\n';
_straddvX+=addvvX(X,"__tmp" + _xbits + "__",nameA);
_straddvX+='#(end macro)    addvvX(X,"__tmp" + _xbits + "__",nameA)' + '\n';
_straddvX+='#(begin macro)    pushvX(X,"__tmp" + _xbits + "__")' + '\n';
_straddvX+=pushvX(X,"__tmp" + _xbits + "__");
_straddvX+='#(end macro)    pushvX(X,"__tmp" + _xbits + "__")' + '\n';
return _straddvX;
}
_str_main+='' + '\n';
...
_strsubvvvX+=scope_begin();
_strsubvvvX+='#(end macro)    scope_begin()' + '\n';
_strsubvvvX+='#(begin macro)        lvarX(X,"negNameB"+_sv4)' + '\n';
_strsubvvvX+=lvarX(X,"negNameB"+_sv4);
_strsubvvvX+='#(end macro)        lvarX(X,"negNameB"+_sv4)' + '\n';
_strsubvvvX+='#(begin macro)        pushvX(X,nameB)' + '\n';
_strsubvvvX+=pushvX(X,nameB);
_strsubvvvX+='#(end macro)        pushvX(X,nameB)' + '\n';
_strsubvvvX+='#(begin macro)        popvX(X,"negNameB"+_sv4)' + '\n';
_strsubvvvX+=popvX(X,"negNameB"+_sv4);
_strsubvvvX+='#(end macro)        popvX(X,"negNameB"+_sv4)' + '\n';
_strsubvvvX+='#(begin macro)        negvX(X,"negNameB"+_sv4)' + '\n';
_strsubvvvX+=negvX(X,"negNameB"+_sv4);
_strsubvvvX+='#(end macro)        negvX(X,"negNameB"+_sv4)' + '\n';
_strsubvvvX+='#(begin macro)        addvvvX(X,name,nameA,"negNameB"+_sv4)' + '\n';
_strsubvvvX+=addvvvX(X,name,nameA,"negNameB"+_sv4);
_strsubvvvX+='#(end macro)        addvvvX(X,name,nameA,"negNameB"+_sv4)' + '\n';
_strsubvvvX+='#(begin macro)    scope_end()' + '\n';
_strsubvvvX+=scope_end();
_strsubvvvX+='#(end macro)    scope_end()' + '\n';
return _strsubvvvX;
...
_strsubvvX+='#(begin macro)     lvarX(X,"subvvXNameB"+_sv11)' + '\n';
_strsubvvX+=lvarX(X,"subvvXNameB"+_sv11);
_strsubvvX+='#(end macro)     lvarX(X,"subvvXNameB"+_sv11)' + '\n';
_strsubvvX+='#(begin macro)     pushvX(X,name)' + '\n';
_strsubvvX+=pushvX(X,name);
_strsubvvX+='#(end macro)     pushvX(X,name)' + '\n';
_strsubvvX+='#(begin macro)     popvX(X,"subvvXNameB"+_sv11)' + '\n';
_strsubvvX+=popvX(X,"subvvXNameB"+_sv11);
_strsubvvX+='#(end macro)     popvX(X,"subvvXNameB"+_sv11)' + '\n';
_strsubvvX+='#(begin macro)    subvvvX(X,name, "subvvXNameB"+_sv11, nameA)' + '\n';
_strsubvvX+=subvvvX(X,name, "subvvXNameB"+_sv11, nameA);
_strsubvvX+='#(end macro)    subvvvX(X,name, "subvvXNameB"+_sv11, nameA)' + '\n';
...
_str_main+='' + '\n';
_str_main+='' + '\n';
_str_main+='#(js) var _sv1; var _sv2; var _sv3; var _sv4; var _sv11;' + '\n';
var _sv1; var _sv2; var _sv3; var _sv4; var _sv11;
_str_main+='#(js) var _sv5; var _sv6; var _sv7; var _sv8; var _sv9;var _sv10;' + '\n';
var _sv5; var _sv6; var _sv7; var _sv8; var _sv9;var _sv10;
_str_main+='#(js) _sv1 = 0; _sv2=0; _sv3 = 0; _sv4 = 0; _sv11 = 0;' + '\n';
_sv1 = 0; _sv2=0; _sv3 = 0; _sv4 = 0; _sv11 = 0;
_str_main+='#(js) _sv5 = 0; _sv6 = 0; _sv7 = 0; _sv8 = 0; _sv9 = 0;_sv10 = 0;' + '\n';
_sv5 = 0; _sv6 = 0; _sv7 = 0; _sv8 = 0; _sv9 = 0;_sv10 = 0;
_str_main+='' + '\n';
