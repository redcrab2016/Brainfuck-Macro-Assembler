...
_str_main+=__indent() +'# ASCII Mandelbrot attempt' + '\n';
_str_main+=__indent() +'# inspired by C code at https://stackoverflow.com/questions/16124127/improvement-to-my-mandelbrot-set-code' + '\n';
...
_str_main+=__indent() +'# fix point number' + '\n';
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro add 2 fixed point number (I+P)*8 bits in stack' + '\n';
var _addFP; _addFP=0;
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro sub 2 fixed point number (I+P)*8 bits in stack' + '\n';
var _subFP; _subFP=0;
...
_strdecFP+=sbmX2(I,"_decFPinput"+_decFP,0,P);
_strdecFP+=__indent() +'#(end macro)sbmX2(I,"_decFPinput"+_decFP,0,P)' + '\n';
_strdecFP+=__indent() +'#(begin macro)decvX(I,"_decFPinput"+_decFP)' + '\n';
_strdecFP+=decvX(I,"_decFPinput"+_decFP);
_strdecFP+=__indent() +'#(end macro)decvX(I,"_decFPinput"+_decFP)' + '\n';
return _strdecFP;
}
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro setFP(I,P,immValue) : set fixed point head of stack I,P (I+P)*8 bits with immediate value' + '\n';
var _setFP; _setFP=0;
...
_strsetFP+=sbmX(IP,"_setFPinstack"+_setFP,0);
...
_strsetFP+=setvX(IP,"_setFPinstack"+_setFP, _fp);
_strsetFP+=__indent() +'#(end macro)setvX(IP,"_setFPinstack"+_setFP, _fp)' + '\n';
return _strsetFP;
}
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro pushFP(I,P,immValue) : push immediate fixed point number onto the stack' + '\n';
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro castFP(I1,P1,I2,P2) : transform head of Stack Fixed point number I1,P1 (I1+P1* 8 bits) into a Fixed point number I2,P2 (I2+P2*8 bits)' + '\n';
...
_strcastFP+=varX(I1P1,"_castFPinstack" +_castFP);
...
_strcastFP+=varX(I2P2,"_castFPoutstack" + _castFP);
...
_strcastFP+=popvX(I1P1,"_castFPinstack" + _castFP);
_strcastFP+=__indent() +'#(end macro)popvX(I1P1,"_castFPinstack" + _castFP)' + '\n';
_strcastFP+=__indent() +'# reset outstack' + '\n';
_strcastFP+=__indent() +'#(begin macro)setvX(I2P2, "_castFPoutstack" +_castFP, 0)' + '\n';
_strcastFP+=setvX(I2P2, "_castFPoutstack" +_castFP, 0);
_strcastFP+=__indent() +'#(end macro)setvX(I2P2, "_castFPoutstack" +_castFP, 0)' + '\n';
_strcastFP+=__indent() +'# sign' + '\n';
_strcastFP+=__indent() +'push _castFPinstack' + (_castFP) + '_s' + '\n';
_strcastFP+=__indent() +'pop _castFPoutstack' + (_castFP) + '_s' + '\n';
_strcastFP+=__indent() +'# integer part' + '\n';
if (I1 >= I2) {
for (var xx = 0 ; xx < I2; xx++) {
_strcastFP+=__indent() +'push _castFPinstack' + (_castFP) + '_' + ((xx + P1)) + '' + '\n';
_strcastFP+=__indent() +'pop _castFPoutstack' + (_castFP) + '_' + ((xx + P2)) + '' + '\n';
}
} else { // I1 < I2
...
_strcastFP+=__indent() +'# fract part' + '\n';
if (P1 >= P2) {
for (var xx = 0 ; xx <P2; xx++) {
_strcastFP+=__indent() +'push _castFPinstack' + (_castFP) + '_' + ((P1-xx-1)) + '' + '\n';
_strcastFP+=__indent() +'pop _castFPoutstack' + (_castFP) + '_' + ((P2-xx-1)) + '' + '\n';
}
} else { // P1 < P2
...
_strcastFP+=pushvX(I2P2,"_castFPoutstack" + _castFP);
_strcastFP+=__indent() +'#(end macro)pushvX(I2P2,"_castFPoutstack" + _castFP)' + '\n';
return _strcastFP;
}
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro integerFP(I,P) : transform head of stack fixed point number I,P (I+P)*8 bits , into a signed integer I*8bits' + '\n';
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro fract(I,P) : retrieve the fractional part of head of stack fixed point number I,P (I+P)*8 bits, into a signed integer P*8 bits' + '\n';
var _fract; _fract=0;
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro mul 2 fixed point number (I+P)*8 bits in stack' + '\n';
var _mulFP; _mulFP=0;
...
_strmulFP+=mulvvvX(IP2,"_mulFPresultX"+_mulFP, "_mulFPnameAX"+_mulFP, "_mulFPnameBX"+_mulFP);
...
_strmulFP+=pushvX(IP2,"_mulFPresultX"+_mulFP);
...
_strmulFP+=popvX(IP,"_mulFPnameA"+_mulFP);
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# 8.16 fixed number' + '\n';
_str_main+=__indent() +'## 8 = 1*8 bits' + '\n';
var FP_I;FP_I='1'; FP_I=(isNaN(FP_I*1))?(FP_I):(FP_I*1); 
_str_main+=__indent() +'## 16 = 2*8 bits' + '\n';
var FP_P;FP_P='2'; FP_P=(isNaN(FP_P*1))?(FP_P):(FP_P*1); 
_str_main+=__indent() +'# FP_I + FP_P' + '\n';
_str_main+=__indent() +'## 1+2 = 3 : 24 bits' + '\n';
var FP;FP='3'; FP=(isNaN(FP*1))?(FP):(FP*1); 
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)varX(FP,"pr")  # pixel real' + '\n';
_str_main+=varX(FP,"pr");
_str_main+=__indent() +'#(end macro)varX(FP,"pr")  # pixel real' + '\n';
_str_main+=__indent() +'#(begin macro)varX(FP,"pi")  # pixel imaginary' + '\n';
_str_main+=varX(FP,"pi");
_str_main+=__indent() +'#(end macro)varX(FP,"pi")  # pixel imaginary' + '\n';
_str_main+=__indent() +'#(begin macro)varX(FP,"x")    # screen coordinate horizontal' + '\n';
_str_main+=varX(FP,"x");
_str_main+=__indent() +'#(end macro)varX(FP,"x")    # screen coordinate horizontal' + '\n';
_str_main+=__indent() +'#(begin macro)varX(FP,"y")    # screen coordinate vertical' + '\n';
_str_main+=varX(FP,"y");
_str_main+=__indent() +'#(end macro)varX(FP,"y")    # screen coordinate vertical' + '\n';
_str_main+=__indent() +'#(begin macro)varX(FP,"newRe")' + '\n';
_str_main+=varX(FP,"newRe");
_str_main+=__indent() +'#(end macro)varX(FP,"newRe")' + '\n';
_str_main+=__indent() +'#(begin macro)varX(FP,"newIm")' + '\n';
_str_main+=varX(FP,"newIm");
_str_main+=__indent() +'#(end macro)varX(FP,"newIm")' + '\n';
_str_main+=__indent() +'#(begin macro)varX(FP,"oldRe")' + '\n';
_str_main+=varX(FP,"oldRe");
_str_main+=__indent() +'#(end macro)varX(FP,"oldRe")' + '\n';
_str_main+=__indent() +'#(begin macro)varX(FP,"oldIm")' + '\n';
_str_main+=varX(FP,"oldIm");
_str_main+=__indent() +'#(end macro)varX(FP,"oldIm")' + '\n';
_str_main+=__indent() +'# varX(FP,"ONE")' + '\n';
_str_main+=__indent() +'var     i' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)declareTmpX(FP)' + '\n';
_str_main+=declareTmpX(FP);
_str_main+=__indent() +'#(end macro)declareTmpX(FP)' + '\n';
_str_main+=__indent() +'#(begin macro)declareTmpX(FP*2)' + '\n';
_str_main+=declareTmpX(FP*2);
_str_main+=__indent() +'#(end macro)declareTmpX(FP*2)' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# pushFP(FP_I,FP_P,1)' + '\n';
_str_main+=__indent() +'# popvX(FP,"ONE")          # ONE = 1.0' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'push    ' + (H) + '' + '\n';
_str_main+=__indent() +'loop' + '\n';
__blockLevel__++;
_str_main+=__indent() +'push    ' + (W) + '' + '\n';
_str_main+=__indent() +'loop' + '\n';
__blockLevel__++;
_str_main+=__indent() +'# pr = 1.5 *(x - halfW) * oneOnHalfZoomW + moveX' + '\n';
_str_main+=__indent() +'#(begin macro)pushFP(FP_I,FP_P,1.5)' + '\n';
_str_main+=pushFP(FP_I,FP_P,1.5);
_str_main+=__indent() +'#(end macro)pushFP(FP_I,FP_P,1.5)' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"x")' + '\n';
_str_main+=pushvX(FP,"x");
_str_main+=__indent() +'#(end macro)pushvX(FP,"x")' + '\n';
...
_str_main+=__indent() +'#(begin macro)subX(FP)' + '\n';
_str_main+=subX(FP);
_str_main+=__indent() +'#(end macro)subX(FP)' + '\n';
...
_str_main+=__indent() +'#(begin macro)addX(FP)' + '\n';
_str_main+=addX(FP);
_str_main+=__indent() +'#(end macro)addX(FP)' + '\n';
_str_main+=__indent() +'#(begin macro)popvX(FP,"pr")' + '\n';
_str_main+=popvX(FP,"pr");
_str_main+=__indent() +'#(end macro)popvX(FP,"pr")' + '\n';
_str_main+=__indent() +'# pi = (y - halfH) * oneOnHalfZoomH + moveY' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"y")' + '\n';
_str_main+=pushvX(FP,"y");
_str_main+=__indent() +'#(end macro)pushvX(FP,"y")' + '\n';
...
_str_main+=addX(FP);
_str_main+=__indent() +'#(end macro)addX(FP)' + '\n';
_str_main+=__indent() +'#(begin macro)popvX(FP,"pi")' + '\n';
_str_main+=popvX(FP,"pi");
_str_main+=__indent() +'#(end macro)popvX(FP,"pi")' + '\n';
_str_main+=__indent() +'# newRe = 0' + '\n';
_str_main+=__indent() +'#(begin macro)setvX(FP,"newRe",0)' + '\n';
_str_main+=setvX(FP,"newRe",0);
_str_main+=__indent() +'#(end macro)setvX(FP,"newRe",0)' + '\n';
_str_main+=__indent() +'# newIm = 0' + '\n';
_str_main+=__indent() +'#(begin macro)setvX(FP,"newIm",0)' + '\n';
_str_main+=setvX(FP,"newIm",0);
_str_main+=__indent() +'#(end macro)setvX(FP,"newIm",0)' + '\n';
_str_main+=__indent() +'# oldRe = 0' + '\n';
_str_main+=__indent() +'#(begin macro)setvX(FP,"oldRe",0)' + '\n';
_str_main+=setvX(FP,"oldRe",0);
_str_main+=__indent() +'#(end macro)setvX(FP,"oldRe",0)' + '\n';
_str_main+=__indent() +'# oldIm = 0' + '\n';
_str_main+=__indent() +'#(begin macro)setvX(FP,"oldIm",0)' + '\n';
_str_main+=setvX(FP,"oldIm",0);
_str_main+=__indent() +'#(end macro)setvX(FP,"oldIm",0)' + '\n';
_str_main+=__indent() +'# i = 0' + '\n';
_str_main+=__indent() +'#(begin macro)at_reset("i")' + '\n';
_str_main+=at_reset("i");
_str_main+=__indent() +'#(end macro)at_reset("i")' + '\n';
_str_main+=__indent() +'# for (i =0 ; i < maxIte; i++) {' + '\n';
_str_main+=__indent() +'push    1' + '\n';
_str_main+=__indent() +'sbm     loop' + '\n';
...
_str_main+=__indent() +'#    oldRe = newRe' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"newRe")' + '\n';
_str_main+=pushvX(FP,"newRe");
_str_main+=__indent() +'#(end macro)pushvX(FP,"newRe")' + '\n';
_str_main+=__indent() +'#(begin macro)popvX(FP,"oldRe")' + '\n';
_str_main+=popvX(FP,"oldRe");
_str_main+=__indent() +'#(end macro)popvX(FP,"oldRe")' + '\n';
_str_main+=__indent() +'#    oldIm = newIm' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"newIm")' + '\n';
_str_main+=pushvX(FP,"newIm");
_str_main+=__indent() +'#(end macro)pushvX(FP,"newIm")' + '\n';
_str_main+=__indent() +'#(begin macro)popvX(FP,"oldIm")' + '\n';
_str_main+=popvX(FP,"oldIm");
_str_main+=__indent() +'#(end macro)popvX(FP,"oldIm")' + '\n';
_str_main+=__indent() +'#    newRe = oldRe * oldRe - oldIm * oldIm + pr' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"oldRe")' + '\n';
_str_main+=pushvX(FP,"oldRe");
_str_main+=__indent() +'#(end macro)pushvX(FP,"oldRe")' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"oldRe")' + '\n';
_str_main+=pushvX(FP,"oldRe");
_str_main+=__indent() +'#(end macro)pushvX(FP,"oldRe")' + '\n';
_str_main+=__indent() +'#(begin macro)mulFP(FP_I,FP_P)' + '\n';
_str_main+=mulFP(FP_I,FP_P);
_str_main+=__indent() +'#(end macro)mulFP(FP_I,FP_P)' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"oldIm")' + '\n';
_str_main+=pushvX(FP,"oldIm");
_str_main+=__indent() +'#(end macro)pushvX(FP,"oldIm")' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"oldIm")' + '\n';
_str_main+=pushvX(FP,"oldIm");
_str_main+=__indent() +'#(end macro)pushvX(FP,"oldIm")' + '\n';
_str_main+=__indent() +'#(begin macro)mulFP(FP_I,FP_P)' + '\n';
...
_str_main+=subX(FP);
_str_main+=__indent() +'#(end macro)subX(FP)' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"pr")' + '\n';
_str_main+=pushvX(FP,"pr");
_str_main+=__indent() +'#(end macro)pushvX(FP,"pr")' + '\n';
_str_main+=__indent() +'#(begin macro)addX(FP)' + '\n';
_str_main+=addX(FP);
_str_main+=__indent() +'#(end macro)addX(FP)' + '\n';
_str_main+=__indent() +'#(begin macro)popvX(FP,"newRe")' + '\n';
_str_main+=popvX(FP,"newRe");
_str_main+=__indent() +'#(end macro)popvX(FP,"newRe")' + '\n';
_str_main+=__indent() +'#    newIm = 2 * oldRe * oldIm + pi' + '\n';
...
_str_main+=mulFP(FP_I,FP_P);
_str_main+=__indent() +'#(end macro)mulFP(FP_I,FP_P)' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"pi")' + '\n';
_str_main+=pushvX(FP,"pi");
_str_main+=__indent() +'#(end macro)pushvX(FP,"pi")' + '\n';
_str_main+=__indent() +'#(begin macro)addX(FP)' + '\n';
_str_main+=addX(FP);
_str_main+=__indent() +'#(end macro)addX(FP)' + '\n';
_str_main+=__indent() +'#(begin macro)popvX(FP,"newIm")' + '\n';
_str_main+=popvX(FP,"newIm");
_str_main+=__indent() +'#(end macro)popvX(FP,"newIm")' + '\n';
_str_main+=__indent() +'#    if (newRe *  newRe +  newIm * newIm) > 4 break for' + '\n';
_str_main+=__indent() +'## newRe *  newRe +  newIm * newIm' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"newRe")' + '\n';
_str_main+=pushvX(FP,"newRe");
_str_main+=__indent() +'#(end macro)pushvX(FP,"newRe")' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"newRe")' + '\n';
...
_str_main+=addX(FP);
_str_main+=__indent() +'#(end macro)addX(FP)' + '\n';
_str_main+=__indent() +'## if stack FP > 4 break' + '\n';
...
_str_main+=__indent() +'#(begin macro)supX(FP)' + '\n';
_str_main+=supX(FP);
_str_main+=__indent() +'#(end macro)supX(FP)' + '\n';
...
_str_main+=__indent() +'# if (i >= maxIte) black point (inside mandel)' + '\n';
...
_str_main+=__indent() +'# else // outside mandel' + '\n';
__blockLevel__--;
_str_main+=__indent() +'else' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print(".")' + '\n';
...
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
_str_main+=__indent() +'# x++' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"x")' + '\n';
_str_main+=pushvX(FP,"x");
_str_main+=__indent() +'#(end macro)pushvX(FP,"x")' + '\n';
_str_main+=__indent() +'#(begin macro)incFP(FP_I,FP_P)' + '\n';
_str_main+=incFP(FP_I,FP_P);
_str_main+=__indent() +'#(end macro)incFP(FP_I,FP_P)' + '\n';
_str_main+=__indent() +'#(begin macro)popvX(FP,"x")' + '\n';
_str_main+=popvX(FP,"x");
_str_main+=__indent() +'#(end macro)popvX(FP,"x")' + '\n';
_str_main+=__indent() +'# addvvvX(FP,"x","x","ONE")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'endloop' + '\n';
_str_main+=__indent() +'# x = 0' + '\n';
_str_main+=__indent() +'#(begin macro)setvX(FP,"x",0)' + '\n';
_str_main+=setvX(FP,"x",0);
_str_main+=__indent() +'#(end macro)setvX(FP,"x",0)' + '\n';
_str_main+=__indent() +'# y++' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX(FP,"y")' + '\n';
_str_main+=pushvX(FP,"y");
_str_main+=__indent() +'#(end macro)pushvX(FP,"y")' + '\n';
_str_main+=__indent() +'#(begin macro)incFP(FP_I,FP_P)' + '\n';
_str_main+=incFP(FP_I,FP_P);
_str_main+=__indent() +'#(end macro)incFP(FP_I,FP_P)' + '\n';
_str_main+=__indent() +'#(begin macro)popvX(FP,"y")' + '\n';
_str_main+=popvX(FP,"y");
_str_main+=__indent() +'#(end macro)popvX(FP,"y")' + '\n';
_str_main+=__indent() +'#  addvvvX(FP,"y","y","ONE")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
__blockLevel__--;
