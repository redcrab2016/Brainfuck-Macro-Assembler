...
_str_main+=__indent() +'# 16 bits signed integer ( 2 bytes) #@(signedX16_inc@1)'+ __context() + '\n';
_str_main+=__indent() +' #@(signedX16_inc@2)'+ __context() + '\n';
...
_str_main+=__indent() +' #@(signedX16_inc@4)'+ __context() + '\n';
_str_main+=__indent() +'# macro var16(name) :declare global 16 bits #@(signedX16_inc@5)'+ __context() + '\n';
var _var16; _var16=0;
...
__context__.push('(signedX16_inc@7)');
_strvar16+=varX(2,name);
__context__.pop();
_strvar16+=__indent() +'#(end macro)varX(2,name)' + '\n';
return _strvar16;
}
_str_main+=__indent() +' #@(signedX16_inc@9)'+ __context() + '\n';
_str_main+=__indent() +'# macro lvar16(name) : declare local 16 bits #@(signedX16_inc@10)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@12)');
_strlvar16+=lvarX(2,name);
__context__.pop();
_strlvar16+=__indent() +'#(end macro)lvarX(2,name)' + '\n';
return _strlvar16;
}
_str_main+=__indent() +' #@(signedX16_inc@14)'+ __context() + '\n';
_str_main+=__indent() +'# macro fixsv16(name) : be sure that name is positive if equal to zero #@(signedX16_inc@15)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@17)');
_strfixsv16+=fixsvX(2,name);
__context__.pop();
_strfixsv16+=__indent() +'#(end macro)fixsvX(2,name)' + '\n';
return _strfixsv16;
}
_str_main+=__indent() +' #@(signedX16_inc@19)'+ __context() + '\n';
_str_main+=__indent() +'# macro pushv16(name) : push 16 bits name on stack #@(signedX16_inc@20)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@22)');
_strpushv16+=pushvX(2,name);
__context__.pop();
_strpushv16+=__indent() +'#(end macro)pushvX(2,name)' + '\n';
return _strpushv16;
}
_str_main+=__indent() +' #@(signedX16_inc@24)'+ __context() + '\n';
_str_main+=__indent() +'# macro push16(immValue) : push immediate16 bits value on the stack #@(signedX16_inc@25)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@27)');
_strpush16+=pushX(2, immValue);
__context__.pop();
_strpush16+=__indent() +'#(end macro)pushX(2, immValue)' + '\n';
return _strpush16;
}
_str_main+=__indent() +' #@(signedX16_inc@29)'+ __context() + '\n';
_str_main+=__indent() +'# macro dup16() : duplicate 16bits value on stack #@(signedX16_inc@30)'+ __context() + '\n';
var _dup16; _dup16=0;
var dup16 = function(){
 _dup16++;
var _strdup16; 
...
__context__.push('(signedX16_inc@32)');
_strdup16+=dupX(2);
__context__.pop();
_strdup16+=__indent() +'#(end macro)dupX(2)' + '\n';
return _strdup16;
}
_str_main+=__indent() +' #@(signedX16_inc@34)'+ __context() + '\n';
_str_main+=__indent() +'# macro pushsv16(name) : push the sign of the 16 bits variable \'name\' #@(signedX16_inc@35)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@37)');
_strpushsv16+=pushsvX(2,name);
__context__.pop();
_strpushsv16+=__indent() +'#(end macro)pushsvX(2,name)' + '\n';
return _strpushsv16;
}
_str_main+=__indent() +' #@(signedX16_inc@39)'+ __context() + '\n';
_str_main+=__indent() +'# macro pushcv16(name) : push the carry of the 16 bits variable \'name\' #@(signedX16_inc@40)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@42)');
_strpushcv16+=pushcvX(2,name);
__context__.pop();
_strpushcv16+=__indent() +'#(end macro)pushcvX(2,name)' + '\n';
return _strpushcv16;
}
_str_main+=__indent() +' #@(signedX16_inc@44)'+ __context() + '\n';
_str_main+=__indent() +'# macro popv16(name) : pop the stack to the 16 bits variable \'name\' #@(signedX16_inc@45)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@47)');
_strpopv16+=popvX(2,name);
__context__.pop();
_strpopv16+=__indent() +'#(end macro)popvX(2,name)' + '\n';
return _strpopv16;
}
_str_main+=__indent() +' #@(signedX16_inc@49)'+ __context() + '\n';
_str_main+=__indent() +'# macro popsv16(name) : pop the sign(8 bits 0/1) to the 16 bits variable \'name\' #@(signedX16_inc@50)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@52)');
_strpopsv16+=popsvX(2,name);
__context__.pop();
_strpopsv16+=__indent() +'#(end macro)popsvX(2,name)' + '\n';
return _strpopsv16;
}
_str_main+=__indent() +' #@(signedX16_inc@54)'+ __context() + '\n';
_str_main+=__indent() +'# macro popcv16(name) : pop the carry(8 bit 0/1) to the 16 bits variable \'name\' #@(signedX16_inc@55)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@57)');
_strpopcv16+=popcvX(2,name);
__context__.pop();
_strpopcv16+=__indent() +'#(end macro)popcvX(2,name)' + '\n';
return _strpopcv16;
}
_str_main+=__indent() +' #@(signedX16_inc@59)'+ __context() + '\n';
_str_main+=__indent() +'# macro negv16(name) : name = -name #@(signedX16_inc@60)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@62)');
_strnegv16+=negvX(2,name);
__context__.pop();
_strnegv16+=__indent() +'#(end macro)negvX(2,name)' + '\n';
return _strnegv16;
}
_str_main+=__indent() +' #@(signedX16_inc@64)'+ __context() + '\n';
_str_main+=__indent() +'# macro absv16(name) : name = abs(name) #@(signedX16_inc@65)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@67)');
_strabsv16+=absvX(2,name);
__context__.pop();
_strabsv16+=__indent() +'#(end macro)absvX(2,name)' + '\n';
return _strabsv16;
}
_str_main+=__indent() +' #@(signedX16_inc@69)'+ __context() + '\n';
_str_main+=__indent() +'# macro abs16() : 16 bits head of stack = abs(16 bits head of stack) #@(signedX16_inc@70)'+ __context() + '\n';
var _abs16; _abs16=0;
var abs16 = function(){
 _abs16++;
var _strabs16; 
...
__context__.push('(signedX16_inc@72)');
_strabs16+=absX(2);
__context__.pop();
_strabs16+=__indent() +'#(end macro)absX(2)' + '\n';
return _strabs16;
}
_str_main+=__indent() +' #@(signedX16_inc@74)'+ __context() + '\n';
_str_main+=__indent() +'# macro neg16() : 16 bits head of stack = - (16 bits head of stack) #@(signedX16_inc@75)'+ __context() + '\n';
var _neg16; _neg16=0;
var neg16 = function(){
 _neg16++;
var _strneg16; 
...
__context__.push('(signedX16_inc@77)');
_strneg16+=negX(2);
__context__.pop();
_strneg16+=__indent() +'#(end macro)negX(2)' + '\n';
return _strneg16;
}
_str_main+=__indent() +' #@(signedX16_inc@79)'+ __context() + '\n';
_str_main+=__indent() +'# macro setc16() : set 1 to 16 bits head of stack carry #@(signedX16_inc@80)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@82)');
_strsetc16+=setcX(2);
__context__.pop();
_strsetc16+=__indent() +'#(end macro)setcX(2)' + '\n';
return _strsetc16;
}
_str_main+=__indent() +' #@(signedX16_inc@84)'+ __context() + '\n';
_str_main+=__indent() +'# macro setcv16(name) : set 1 to 16 bits variable \'name\' carry #@(signedX16_inc@85)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@87)');
_strsetcv16+=setcvX(2,name);
__context__.pop();
_strsetcv16+=__indent() +'#(end macro)setcvX(2,name)' + '\n';
return _strsetcv16;
}
_str_main+=__indent() +' #@(signedX16_inc@89)'+ __context() + '\n';
_str_main+=__indent() +'# macro clearc16() : set 0 to 16 bits head of stack carry #@(signedX16_inc@90)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@92)');
_strclearc16+=clearcX(2);
__context__.pop();
_strclearc16+=__indent() +'#(end macro)clearcX(2)' + '\n';
return _strclearc16;
}
_str_main+=__indent() +' #@(signedX16_inc@94)'+ __context() + '\n';
_str_main+=__indent() +'# macro clearcv16(name) : set 0 to 16 bits variable \'name\' carry #@(signedX16_inc@95)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@97)');
_strclearcv16+=clearcvX(2,name);
__context__.pop();
_strclearcv16+=__indent() +'#(end macro)clearcvX(2,name)' + '\n';
return _strclearcv16;
}
_str_main+=__indent() +' #@(signedX16_inc@99)'+ __context() + '\n';
_str_main+=__indent() +'# macro drop16() : drop 16 bits value from stack #@(signedX16_inc@100)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@102)');
_strdrop16+=dropX(2);
__context__.pop();
_strdrop16+=__indent() +'#(end macro)dropX(2)' + '\n';
return _strdrop16;
}
_str_main+=__indent() +' #@(signedX16_inc@104)'+ __context() + '\n';
_str_main+=__indent() +'# macro reset16() : reset 16 bits value of the head of stack #@(signedX16_inc@105)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@107)');
_strreset16+=resetX(2);
__context__.pop();
_strreset16+=__indent() +'#(end macro)resetX(2)' + '\n';
return _strreset16;
}
_str_main+=__indent() +' #@(signedX16_inc@109)'+ __context() + '\n';
_str_main+=__indent() +'# macro resetv16(name) : reset 16 bits variable \'name\' #@(signedX16_inc@110)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@112)');
_strresetv16+=resetvX(2,name);
__context__.pop();
_strresetv16+=__indent() +'#(end macro)resetvX(2,name)' + '\n';
return _strresetv16;
}
_str_main+=__indent() +' #@(signedX16_inc@114)'+ __context() + '\n';
_str_main+=__indent() +'# macro set16(immValue) : set 16 bits value on the head of stack #@(signedX16_inc@115)'+ __context() + '\n';
var _set16; _set16=0;
...
__context__.push('(signedX16_inc@117)');
_strset16+=setX(2,immValue);
__context__.pop();
_strset16+=__indent() +'#(end macro)setX(2,immValue)' + '\n';
return _strset16;
}
_str_main+=__indent() +' #@(signedX16_inc@119)'+ __context() + '\n';
_str_main+=__indent() +'# macro setv16(name, immValue) : set 16 bits immediate value to a 16 bits variable \'name\' #@(signedX16_inc@120)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@122)');
_strsetv16+=setvX(2,name, immValue);
__context__.pop();
_strsetv16+=__indent() +'#(end macro)setvX(2,name, immValue)' + '\n';
return _strsetv16;
}
_str_main+=__indent() +' #@(signedX16_inc@124)'+ __context() + '\n';
_str_main+=__indent() +'# macro fixsv16(name) : be sure to have sign to zero if 16 bits variable \'name\' is zero #@(signedX16_inc@125)'+ __context() + '\n';
var _fixsv16; _fixsv16=0;
var fixsv16 = function(name){
 _fixsv16++;
var _strfixsv16; 
...
if (arguments.length != 1) throw 'Too much arguments provided to macro fixsv16(name)[' + [name] +']';
_strfixsv16+=__indent() +'#(begin macro)fixsvX(2,name)' + '\n';
__context__.push('(signedX16_inc@127)');
_strfixsv16+=fixsvX(2,name);
__context__.pop();
_strfixsv16+=__indent() +'#(end macro)fixsvX(2,name)' + '\n';
return _strfixsv16;
}
_str_main+=__indent() +' #@(signedX16_inc@129)'+ __context() + '\n';
_str_main+=__indent() +'# macro fixs16() : be sure to have sign to zero if 16 bits head of stack value is zero #@(signedX16_inc@130)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@132)');
_strfixs16+=fixsX(2);
__context__.pop();
_strfixs16+=__indent() +'#(end macro)fixsX(2)' + '\n';
return _strfixs16;
}
_str_main+=__indent() +' #@(signedX16_inc@134)'+ __context() + '\n';
_str_main+=__indent() +'# macro bool16() : same as \'bool\' but with a 16 bits value on stack #@(signedX16_inc@135)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@137)');
_strbool16+=boolX(2);
__context__.pop();
_strbool16+=__indent() +'#(end macro)boolX(2)' + '\n';
return _strbool16;
}
_str_main+=__indent() +' #@(signedX16_inc@139)'+ __context() + '\n';
_str_main+=__indent() +'# macro boolv16(name) : push on stack the bool(name) 16 bits #@(signedX16_inc@140)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@142)');
_strboolv16+=boolvX(2,name);
__context__.pop();
_strboolv16+=__indent() +'#(end macro)boolvX(2,name)' + '\n';
return _strboolv16;
}
_str_main+=__indent() +' #@(signedX16_inc@144)'+ __context() + '\n';
_str_main+=__indent() +'# macro incv16(name) : name = name +1 (16 bits) #@(signedX16_inc@145)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@147)');
_strincv16+=incvX(2,name);
__context__.pop();
_strincv16+=__indent() +'#(end macro)incvX(2,name)' + '\n';
return _strincv16;
}
_str_main+=__indent() +' #@(signedX16_inc@149)'+ __context() + '\n';
_str_main+=__indent() +'# macro inc16() : 16 bits head of stack value incremented #@(signedX16_inc@150)'+ __context() + '\n';
var _inc16; _inc16=0;
var inc16 = function(){
 _inc16++;
var _strinc16; 
...
__context__.push('(signedX16_inc@152)');
_strinc16+=incX(2);
__context__.pop();
_strinc16+=__indent() +'#(end macro)incX(2)' + '\n';
return _strinc16;
}
_str_main+=__indent() +' #@(signedX16_inc@154)'+ __context() + '\n';
_str_main+=__indent() +'# macro decv16(name) : name-- (16 bits) #@(signedX16_inc@155)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@157)');
_strdecv16+=decvX(2,name);
__context__.pop();
_strdecv16+=__indent() +'#(end macro)decvX(2,name)' + '\n';
return _strdecv16;
}
_str_main+=__indent() +' #@(signedX16_inc@159)'+ __context() + '\n';
_str_main+=__indent() +'# macro dec16() : 16 bits head of stack value decrement #@(signedX16_inc@160)'+ __context() + '\n';
var _dec16; _dec16=0;
var dec16 = function(){
 _dec16++;
var _strdec16; 
...
__context__.push('(signedX16_inc@162)');
_strdec16+=decX(2);
__context__.pop();
_strdec16+=__indent() +'#(end macro)decX(2)' + '\n';
return _strdec16;
}
_str_main+=__indent() +' #@(signedX16_inc@164)'+ __context() + '\n';
_str_main+=__indent() +'# macro addvi16(name, immValue) : name += immediate value #@(signedX16_inc@165)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@167)');
_straddvi16+=addviX(2,name,immValue);
__context__.pop();
_straddvi16+=__indent() +'#(end macro)addviX(2,name,immValue)' + '\n';
return _straddvi16;
}
_str_main+=__indent() +' #@(signedX16_inc@169)'+ __context() + '\n';
_str_main+=__indent() +'# macro addi16(immValue) : 16 bits head of stack value += immediate value #@(signedX16_inc@170)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@172)');
_straddi16+=addiX(2,immValue);
__context__.pop();
_straddi16+=__indent() +'#(end macro)addiX(2,immValue)' + '\n';
return _straddi16;
}
_str_main+=__indent() +' #@(signedX16_inc@174)'+ __context() + '\n';
_str_main+=__indent() +'# macro subvi16(name, immValue) : name -= immediate value #@(signedX16_inc@175)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@177)');
_strsubvi16+=subviX(2,name,immValue);
__context__.pop();
_strsubvi16+=__indent() +'#(end macro)subviX(2,name,immValue)' + '\n';
return _strsubvi16;
}
_str_main+=__indent() +' #@(signedX16_inc@179)'+ __context() + '\n';
_str_main+=__indent() +'# macro subi16(immValue) : 16 bits head of stack value -= immediate value #@(signedX16_inc@180)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@182)');
_strsubi16+=subiX(2,immValue);
__context__.pop();
_strsubi16+=__indent() +'#(end macro)subiX(2,immValue)' + '\n';
return _strsubi16;
}
_str_main+=__indent() +' #@(signedX16_inc@184)'+ __context() + '\n';
_str_main+=__indent() +'# macro addvvv16(name, nameA, nameB) : name = nameA + nameB #@(signedX16_inc@185)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@187)');
_straddvvv16+=addvvvX(2,name,nameA,nameB);
__context__.pop();
_straddvvv16+=__indent() +'#(end macro)addvvvX(2,name,nameA,nameB)' + '\n';
return _straddvvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@189)'+ __context() + '\n';
_str_main+=__indent() +'# macro addvv16(name, nameA) : name += nameA #@(signedX16_inc@190)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@192)');
_straddvv16+=addvvX(2,name,nameA);
__context__.pop();
_straddvv16+=__indent() +'#(end macro)addvvX(2,name,nameA)' + '\n';
return _straddvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@194)'+ __context() + '\n';
_str_main+=__indent() +'# macro addv16(nameA) : head stack += nameA #@(signedX16_inc@195)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@197)');
_straddv16+=addvX(2,nameA);
__context__.pop();
_straddv16+=__indent() +'#(end macro)addvX(2,nameA)' + '\n';
return _straddv16;
}
_str_main+=__indent() +' #@(signedX16_inc@199)'+ __context() + '\n';
_str_main+=__indent() +'# macro add16() : stack-1 = stack-1 + stack ; stack-- #@(signedX16_inc@200)'+ __context() + '\n';
var _add16; _add16=0;
var add16 = function(){
 _add16++;
var _stradd16; 
...
__context__.push('(signedX16_inc@202)');
_stradd16+=addX(2);
__context__.pop();
_stradd16+=__indent() +'#(end macro)addX(2)' + '\n';
return _stradd16;
}
_str_main+=__indent() +' #@(signedX16_inc@204)'+ __context() + '\n';
_str_main+=__indent() +'# macro subvvv16(name, nameA, nameB) : name = nameA - nameB #@(signedX16_inc@205)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@207)');
_strsubvvv16+=subvvvX(2,name,nameA,nameB);
__context__.pop();
_strsubvvv16+=__indent() +'#(end macro)subvvvX(2,name,nameA,nameB)' + '\n';
return _strsubvvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@209)'+ __context() + '\n';
_str_main+=__indent() +'# macro subvv16(name, nameA) : name -= nameA #@(signedX16_inc@210)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@212)');
_strsubvv16+=subvvX(2,name,nameA);
__context__.pop();
_strsubvv16+=__indent() +'#(end macro)subvvX(2,name,nameA)' + '\n';
return _strsubvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@214)'+ __context() + '\n';
_str_main+=__indent() +'# macro subv16(nameA) : head stack -= nameA #@(signedX16_inc@215)'+ __context() + '\n';
var _addv16; _addv16=0;
var addv16 = function(nameA){
 _addv16++;
var _straddv16; 
...
if (arguments.length != 1) throw 'Too much arguments provided to macro addv16(nameA)[' + [nameA] +']';
_straddv16+=__indent() +'#(begin macro)addvX(2,nameA)' + '\n';
__context__.push('(signedX16_inc@217)');
_straddv16+=addvX(2,nameA);
__context__.pop();
_straddv16+=__indent() +'#(end macro)addvX(2,nameA)' + '\n';
return _straddv16;
}
_str_main+=__indent() +' #@(signedX16_inc@219)'+ __context() + '\n';
_str_main+=__indent() +'# macro sub16() : stack-1 = stack-1 - stack ; stack-- #@(signedX16_inc@220)'+ __context() + '\n';
var _sub16; _sub16=0;
var sub16 = function(){
 _sub16++;
var _strsub16; 
...
__context__.push('(signedX16_inc@222)');
_strsub16+=subX(2);
__context__.pop();
_strsub16+=__indent() +'#(end macro)subX(2)' + '\n';
return _strsub16;
}
_str_main+=__indent() +' #@(signedX16_inc@224)'+ __context() + '\n';
_str_main+=__indent() +'# macro mulvvv16(name, nameA, nameB) : name = nameA * nameB #@(signedX16_inc@225)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@227)');
_strmulvvv16+=mulvvvX(2, name, nameA, nameB);
__context__.pop();
_strmulvvv16+=__indent() +'#(end macro)mulvvvX(2, name, nameA, nameB)' + '\n';
return _strmulvvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@229)'+ __context() + '\n';
_str_main+=__indent() +'# macro mulvv16(name, nameA) : name *= nameA #@(signedX16_inc@230)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@232)');
_strmulvv16+=mulvvX(2,name,nameA);
__context__.pop();
_strmulvv16+=__indent() +'#(end macro)mulvvX(2,name,nameA)' + '\n';
return _strmulvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@234)'+ __context() + '\n';
_str_main+=__indent() +'# macro mulv16(name) : head of stack *= name #@(signedX16_inc@235)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@237)');
_strmulv16+=mulvX(2,name);
__context__.pop();
_strmulv16+=__indent() +'#(end macro)mulvX(2,name)' + '\n';
return _strmulv16;
}
_str_main+=__indent() +' #@(signedX16_inc@239)'+ __context() + '\n';
_str_main+=__indent() +'# macro mul16() : stack-1 = stack-1 * stack : stack-- #@(signedX16_inc@240)'+ __context() + '\n';
var _mul16; _mul16=0;
var mul16 = function(){
 _mul16++;
var _strmul16; 
...
__context__.push('(signedX16_inc@242)');
_strmul16+=mulX(2);
__context__.pop();
_strmul16+=__indent() +'#(end macro)mulX(2)' + '\n';
return _strmul16;
}
_str_main+=__indent() +' #@(signedX16_inc@244)'+ __context() + '\n';
_str_main+=__indent() +'# macro equalvv16(nameA, nameB) : push 1 if NameA == NameB , push 0 otherwise #@(signedX16_inc@245)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@247)');
_strequalvv16+=equalvvX(2, nameA, nameB);
__context__.pop();
_strequalvv16+=__indent() +'#(end macro)equalvvX(2, nameA, nameB)' + '\n';
return _strequalvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@249)'+ __context() + '\n';
_str_main+=__indent() +'# macro equal16() : same as "equal" but with 16 bits value in stack #@(signedX16_inc@250)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@252)');
_strequal16+=equalX(2);
__context__.pop();
_strequal16+=__indent() +'#(end macro)equalX(2)' + '\n';
return _strequal16;
}
_str_main+=__indent() +' #@(signedX16_inc@254)'+ __context() + '\n';
_str_main+=__indent() +'# macro diffvv16(nameA, nameB) : push 1 if Name != NameB , push 0 otherwise #@(signedX16_inc@255)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@257)');
_strdiffvv16+=diffvvX(2, nameA, nameB);
__context__.pop();
_strdiffvv16+=__indent() +'#(end macro)diffvvX(2, nameA, nameB)' + '\n';
return _strdiffvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@259)'+ __context() + '\n';
_str_main+=__indent() +'# macro diff16() : same as "diff" but with 16 bits value in stack #@(signedX16_inc@260)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@262)');
_strdiff16+=diffX(2);
__context__.pop();
_strdiff16+=__indent() +'#(end macro)diffX(2)' + '\n';
return _strdiff16;
}
_str_main+=__indent() +' #@(signedX16_inc@264)'+ __context() + '\n';
_str_main+=__indent() +'# macro supequalvv16(nameA, nameB) : push 1 if nameA >= nameB push 0 otherwise #@(signedX16_inc@265)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@267)');
...
_str_main+=__indent() +' #@(signedX16_inc@269)'+ __context() + '\n';
_str_main+=__indent() +'# macro supequal16() : push 1 if stack-1 >= stack , push 0 otherwise : after dropped 2 16 bits value from stack #@(signedX16_inc@270)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@272)');
_strsupequal16+=supequalX(2);
__context__.pop();
_strsupequal16+=__indent() +'#(end macro)supequalX(2)' + '\n';
return _strsupequal16;
}
_str_main+=__indent() +' #@(signedX16_inc@274)'+ __context() + '\n';
_str_main+=__indent() +'# macro infvv16(nameA, nameB) : push 1 if nameA < nameB push 0 otherwise #@(signedX16_inc@275)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@277)');
_strinfvv16+=infvvX(2, nameA, nameB);
__context__.pop();
_strinfvv16+=__indent() +'#(end macro)infvvX(2, nameA, nameB)' + '\n';
return _strinfvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@279)'+ __context() + '\n';
_str_main+=__indent() +'# macro inf16() : push 1 if stack-1 < stack, push 0 otherwise : after dropped 2 16 bits value from stack #@(signedX16_inc@280)'+ __context() + '\n';
var _inf16; _inf16=0;
var inf16 = function(){
 _inf16++;
var _strinf16; 
...
__context__.push('(signedX16_inc@282)');
_strinf16+=infX(2);
__context__.pop();
_strinf16+=__indent() +'#(end macro)infX(2)' + '\n';
return _strinf16;
}
_str_main+=__indent() +' #@(signedX16_inc@284)'+ __context() + '\n';
_str_main+=__indent() +'# macro infequalvv16(nameA, nameB) : push 1 if nameA <= nameB push 0 otherwise #@(signedX16_inc@285)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@287)');
...
_str_main+=__indent() +' #@(signedX16_inc@289)'+ __context() + '\n';
_str_main+=__indent() +'# macro infequal16() : push 1 if stack-1 <= stack, push 0 otherwise : after dropped 2 16 bits value from stack #@(signedX16_inc@290)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@292)');
_strinfequal16+=infequalX(2);
__context__.pop();
_strinfequal16+=__indent() +'#(end macro)infequalX(2)' + '\n';
return _strinfequal16;
}
_str_main+=__indent() +' #@(signedX16_inc@294)'+ __context() + '\n';
_str_main+=__indent() +'# macro supvv16(nameA , nameB) : push 1 if nameA > nameB push 0 otherwise #@(signedX16_inc@295)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@297)');
_strsupvv16+=supvvX(2,nameA,nameB);
__context__.pop();
_strsupvv16+=__indent() +'#(end macro)supvvX(2,nameA,nameB)' + '\n';
return _strsupvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@299)'+ __context() + '\n';
_str_main+=__indent() +'# macro sup16() : push 1 if stack-1 > stack, push 0 otherwise : after dropped 2 16 bits value from stack #@(signedX16_inc@300)'+ __context() + '\n';
var _sup16; _sup16=0;
var sup16 = function(){
 _sup16++;
var _strsup16; 
...
__context__.push('(signedX16_inc@302)');
_strsup16+=supX(2);
__context__.pop();
_strsup16+=__indent() +'#(end macro)supX(2)' + '\n';
return _strsup16;
}
_str_main+=__indent() +' #@(signedX16_inc@304)'+ __context() + '\n';
_str_main+=__indent() +'# macro divvvvv16(nameAdivB, nameAmodB, nameA, nameB) : nameAdivB = nameA div nameB ; nameAmodB = nameA mod nameB #@(signedX16_inc@305)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@307)');
...
_str_main+=__indent() +' #@(signedX16_inc@309)'+ __context() + '\n';
_str_main+=__indent() +'# macro divvv16(nameA, nameB) : Push 2 16 bits values  : stack-1 = nameA mod nameB ; stack = nameA div nameB #@(signedX16_inc@310)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@312)');
_strdivvv16+=divvvX(2,nameA,nameB);
__context__.pop();
_strdivvv16+=__indent() +'#(end macro)divvvX(2,nameA,nameB)' + '\n';
return _strdivvv16;
}
_str_main+=__indent() +' #@(signedX16_inc@314)'+ __context() + '\n';
_str_main+=__indent() +'# macro div16() : stack-1 == A , stack == B ; stack-1 = A mod B , stack = A div B #@(signedX16_inc@315)'+ __context() + '\n';
var _div16; _div16=0;
var div16 = function(){
 _div16++;
var _strdiv16; 
...
__context__.push('(signedX16_inc@317)');
_strdiv16+=divX(2);
__context__.pop();
_strdiv16+=__indent() +'#(end macro)divX(2)' + '\n';
return _strdiv16;
}
_str_main+=__indent() +' #@(signedX16_inc@319)'+ __context() + '\n';
_str_main+=__indent() +'# macro write16(name) : print out the decimal value (signed) #@(signedX16_inc@320)'+ __context() + '\n';
...
__context__.push('(signedX16_inc@322)');
_strwrite16+=writeX(2,name);
__context__.pop();
_strwrite16+=__indent() +'#(end macro)writeX(2,name)' + '\n';
return _strwrite16;
}
_str_main+=__indent() +' #@(signedX16_inc@324)'+ __context() + '\n';
_str_main+=__indent() +'# macro printhexa16(name) : print the 16 bit variable in hexadecimal #@(signedX16_inc@325)'+ __context() + '\n';
...
_str_main+=printhexa16(((isNaN(('number1')*1))?('number1'):(('number1')*1)));
__context__.pop();
...
_str_main+=__indent() +' #@(main@25)'+ __context() + '\n';
...
_str_main+=printhexa16(((isNaN(('number2')*1))?('number2'):(('number2')*1)));
__context__.pop();
...
__context__.pop();
_str_main+=__indent() +'#(end macro)print("          c s 1 0\\n\\n")' + '\n';
_str_main+=__indent() +' #@(main@30)'+ __context() + '\n';
...
_str_main+=write16(((isNaN(('number1')*1))?('number1'):(('number1')*1)));
__context__.pop();
...
_str_main+=write16(((isNaN(('number2')*1))?('number2'):(('number2')*1)));
__context__.pop();
...
_str_main+=addvv16(((isNaN(('number1')*1))?('number1'):(('number1')*1)),((isNaN(('number2')*1))?('number2'):(('number2')*1)));
__context__.pop();
...
_str_main+=subvv16(((isNaN(('number1')*1))?('number1'):(('number1')*1)),((isNaN(('number2')*1))?('number2'):(('number2')*1)));
__context__.pop();
...
__context__.pop();
_str_main+=__indent() +'#(end macro)print("          c s 1 0\\n")' + '\n';
_str_main+=__indent() +' #@(main@52)'+ __context() + '\n';
_str_main+=__indent() +'#(begin macro)print("[number2]")' + '\n';
...
__context__.pop();
_str_main+=__indent() +'#(end macro)print("          c s 1 0\\n\\n")' + '\n';
_str_main+=__indent() +' #@(main@57)'+ __context() + '\n';
_str_main+=__indent() +'#(begin macro)addvv16 number2,    number1' + '\n';
__context__.push('(main@58)');
_str_main+=addvv16(((isNaN(('number2')*1))?('number2'):(('number2')*1)),((isNaN(('number1')*1))?('number1'):(('number1')*1)));
__context__.pop();
...
_str_main+=subvv16(((isNaN(('number2')*1))?('number2'):(('number2')*1)),((isNaN(('number1')*1))?('number1'):(('number1')*1)));
__context__.pop();
...
_str_main+=__indent() +'drop #@(main@79)'+ __context() + '\n';
