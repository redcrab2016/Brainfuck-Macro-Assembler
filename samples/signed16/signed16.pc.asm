...
# macro addiX(X,immValue) : 16 bits head of stack value += immediate value
...
#(begin macro)    print("16 bits Hexa dump\n")
    push    0
...
#(js) }
    drop
#(end macro)    print("16 bits Hexa dump\n")
...
#(begin macro)        popvX(X,"writeX_B"+_writeX)
#(js) for (var xx=0; xx < X; xx++) {
    pop     writeX_B1_0
#(js) }
    pop     writeX_B1_1
#(js) }
    pop     writeX_B1_s
    pop     writeX_B1_c
#(end macro)        popvX(X,"writeX_B"+_writeX)
...
#(begin macro)    addvvvX(X,name, "_addvvXnameB"+_addvvX, nameA)
    ...
    if      # nameA and nameB are both positive or negative
        push    _addvvXnameB1_s
        pop     number1_s    # name has same sign of nameA and nameB
        push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
...
#(js) }
            ...
            if  # absA > absB : do  absA-absB with sign of A
                # print("absA > absB\n")
                push    _addvvXnameB1_s
                pop     number1_s    # name has same sign of nameA 
                push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                push    _addvvXnameB1_0
                swap
...
#(end macro)                    setvX(X,name,0) 
                    ...
                    #print("absA < absB\n")
                    push    number2_s
                    pop     number1_s    # name has same sign of nameB
                    push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                    push    number2_0
                    swap
...
#(begin macro)    subvv16("number1","number2")
#(begin macro)    subvvX(2,name,nameA)
#(begin macro)    scope_begin()
#(js) __scope.push(0);
#(end macro)    scope_begin()
#(begin macro)     lvarX(X, "_subvvXNameB" + _subvvX)
...
#(js) if (__scope.length > 0) __scope.splice(__scope.length-1, 1);
#(end macro)    scope_end()
#(end macro)    subvvX(2,name,nameA)
#(end macro)    subvv16("number1","number2")
#(begin macro)    print("[number1-=number2]")
    push    0
#(js) var __prev; __prev = 0;
#(js) for (var istr=0; istr < aString.length ; istr++) {
...
#(begin macro)    addvv16("number2","number1")
#(begin macro)    addvvX(2,name,nameA)
#(begin macro)    scope_begin()
#(js) __scope.push(0);
#(end macro)    scope_begin()
...
#(begin macro)    addvvvX(X,name, "_addvvXnameB"+_addvvX, nameA)
    ...
    if      # nameA and nameB are both positive or negative
        push    _addvvXnameB2_s
        pop     number2_s    # name has same sign of nameA and nameB
        push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
...
#(js) }
            ...
            if  # absA > absB : do  absA-absB with sign of A
                # print("absA > absB\n")
                push    _addvvXnameB2_s
                pop     number2_s    # name has same sign of nameA 
                push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                push    _addvvXnameB2_0
                swap
...
#(end macro)                    setvX(X,name,0) 
                    ...
                    #print("absA < absB\n")
                    push    number1_s
                    pop     number2_s    # name has same sign of nameB
                    push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                    push    number1_0
                    swap
...
#(end macro)    scope_end()
#(end macro)    addvvX(2,name,nameA)
#(end macro)    addvv16("number2","number1")
#(begin macro)    print("[number2+=number1]") 
    push    0
#(js) var __prev; __prev = 0;
#(js) for (var istr=0; istr < aString.length ; istr++) {
#(js) var __ascii; __ascii = aString[istr].charCodeAt(0);
...
#(js) }
    drop
#(end macro)    print("[number2+=number1]") 
#(begin macro)    write16("number2")
#(begin macro)    writeX(2,name)
#(js) var _xbits; _xbits = X * 8;
#(begin macro)    scope_begin()
...
#(begin macro)    lvar(name + "_c",0)
    push 0
    sbm _divvvvvXabsNameA5_c
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_c",0)
#(begin macro)    lvar(name + "_s",0)
    push 0
    sbm _divvvvvXabsNameA5_s
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_s",0)
#(js) for (var xx =0 ; xx < X ; xx++) {
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
...
#(begin macro)        popvX(X,"_divvvvvXabsNameA" + _divvvvvX)
#(js) for (var xx=0; xx < X; xx++) {
    pop     _divvvvvXabsNameA5_0
#(js) }
    pop     _divvvvvXabsNameA5_1
#(js) }
    pop     _divvvvvXabsNameA5_s
    pop     _divvvvvXabsNameA5_c
#(end macro)        popvX(X,"_divvvvvXabsNameA" + _divvvvvX)
#(begin macro)        lvar("_divvvvvXsA" + _divvvvvX, 0)
    push 0
    sbm _divvvvvXsA5
...
#(begin macro)    lvar(name + "_c",0)
    push 0
    sbm _divvvvvXabsNameB5_c
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_c",0)
#(begin macro)    lvar(name + "_s",0)
    push 0
    sbm _divvvvvXabsNameB5_s
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_s",0)
#(js) for (var xx =0 ; xx < X ; xx++) {
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
...
#(begin macro)        popvX(X,"_divvvvvXabsNameB" + _divvvvvX)
#(js) for (var xx=0; xx < X; xx++) {
    pop     _divvvvvXabsNameB5_0
#(js) }
    pop     _divvvvvXabsNameB5_1
#(js) }
    pop     _divvvvvXabsNameB5_s
    pop     _divvvvvXabsNameB5_c
#(end macro)        popvX(X,"_divvvvvXabsNameB" + _divvvvvX)
#(begin macro)        lvar("_divvvvvXsB" + _divvvvvX, 0)
    push 0
    sbm _divvvvvXsB5
...
#(begin macro)        pushvX(X,"_divvvvvXabsNameA" + _divvvvvX)
    push    _divvvvvXabsNameA5_c
    push    _divvvvvXabsNameA5_s
#(js) for (var xx =0 ; xx < X ; xx++) {
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
    push    _divvvvvXabsNameA5_1
#(js) }
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
    push    _divvvvvXabsNameA5_0
#(js) }
#(end macro)        pushvX(X,"_divvvvvXabsNameA" + _divvvvvX)
#(begin macro)        popvX(X,nameAmodB)
#(js) for (var xx=0; xx < X; xx++) {
...
#(begin macro)        boolvX(X,"_divvvvvXabsNameB" + _divvvvvX)
#(js) for (var xx = 0 ; xx < X; xx++) {
    push _divvvvvXabsNameB5_0
    bool
#(js) }
    push _divvvvvXabsNameB5_1
    bool
#(js) }
#(js) for (var xx = 0 ; xx < X-1; xx++) {
    or
...
#(end macro)        lvarX(X,"_negNameB" + _subvvvX)
#(begin macro)        pushvX(X,nameB)
    push    _divvvvvXabsNameB5_c
    push    _divvvvvXabsNameB5_s
#(js) for (var xx =0 ; xx < X ; xx++) {
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
    push    _divvvvvXabsNameB5_1
#(js) }
...
#(begin macro)        addvvvX(X, name, nameA, "_negNameB" + _subvvvX)
    ...
    if      # nameA and nameB are both positive or negative
        push    _subvvXNameB6_s
        pop     writeX_AmodB5_s    # name has same sign of nameA and nameB
        push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
        push    _subvvXNameB6_0
#(begin macro)        addof()
    sbm _addofb73
    sbm _addofa73 - 1
#(begin macro)    scope_begin()
...
#(js) }
            ...
            if  # absA > absB : do  absA-absB with sign of A
                # print("absA > absB\n")
                push    _subvvXNameB6_s
                pop     writeX_AmodB5_s    # name has same sign of nameA 
                push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                push    _subvvXNameB6_0
                swap
...
#(end macro)                    setvX(X,name,0) 
                    ...
                    #print("absA < absB\n")
                    push    _negNameB11_s
                    pop     writeX_AmodB5_s    # name has same sign of nameB
                    push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                    push    _negNameB11_0
                    swap
...
#(end macro)                    at_reset("_divvvvvX_g" + _divvvvvX) # break while/wend
            ...
            # treat sign of nameAmodB and nameAdivB
            push    _divvvvvXsA5
            pop     writeX_AmodB5_s   # sign of nameAmodB is sign of nameA
            push    _divvvvvXsA5
            push    _divvvvvXsB5
            diff
            if
                push    1
                pop     writeX_AdivB5_s # nameAdivB is negative if sign NameA <> sign nameB
            fi
        else
#(begin macro)            setcvX(X,nameAdivB)
#(begin macro)    at_set(name+"_c",1)
...
#(begin macro)    subvv16("number2","number1")
#(begin macro)    subvvX(2,name,nameA)
#(begin macro)    scope_begin()
#(js) __scope.push(0);
#(end macro)    scope_begin()
...
#(end macro)    scope_end()
#(end macro)    subvvX(2,name,nameA)
#(end macro)    subvv16("number2","number1")
#(begin macro)    print("[number2-=number1]")
    push    0
#(js) var __prev; __prev = 0;
#(js) for (var istr=0; istr < aString.length ; istr++) {
...
#(begin macro)    lvar(name + "_c",0)
    push 0
    sbm _divvvvvXabsNameA6_c
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_c",0)
#(begin macro)    lvar(name + "_s",0)
    push 0
    sbm _divvvvvXabsNameA6_s
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_s",0)
#(js) for (var xx =0 ; xx < X ; xx++) {
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
...
#(begin macro)        popvX(X,"_divvvvvXabsNameA" + _divvvvvX)
#(js) for (var xx=0; xx < X; xx++) {
    pop     _divvvvvXabsNameA6_0
#(js) }
    pop     _divvvvvXabsNameA6_1
#(js) }
    pop     _divvvvvXabsNameA6_s
    pop     _divvvvvXabsNameA6_c
#(end macro)        popvX(X,"_divvvvvXabsNameA" + _divvvvvX)
#(begin macro)        lvar("_divvvvvXsA" + _divvvvvX, 0)
    push 0
    sbm _divvvvvXsA6
...
#(begin macro)    lvar(name + "_c",0)
    push 0
    sbm _divvvvvXabsNameB6_c
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_c",0)
#(begin macro)    lvar(name + "_s",0)
    push 0
    sbm _divvvvvXabsNameB6_s
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_s",0)
#(js) for (var xx =0 ; xx < X ; xx++) {
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
...
#(begin macro)        popvX(X,"_divvvvvXabsNameB" + _divvvvvX)
#(js) for (var xx=0; xx < X; xx++) {
    pop     _divvvvvXabsNameB6_0
#(js) }
    pop     _divvvvvXabsNameB6_1
#(js) }
    pop     _divvvvvXabsNameB6_s
    pop     _divvvvvXabsNameB6_c
#(end macro)        popvX(X,"_divvvvvXabsNameB" + _divvvvvX)
#(begin macro)        lvar("_divvvvvXsB" + _divvvvvX, 0)
    push 0
    sbm _divvvvvXsB6
...
#(begin macro)        pushvX(X,"_divvvvvXabsNameA" + _divvvvvX)
    push    _divvvvvXabsNameA6_c
    push    _divvvvvXabsNameA6_s
#(js) for (var xx =0 ; xx < X ; xx++) {
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
    push    _divvvvvXabsNameA6_1
#(js) }
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
    push    _divvvvvXabsNameA6_0
#(js) }
#(end macro)        pushvX(X,"_divvvvvXabsNameA" + _divvvvvX)
#(begin macro)        popvX(X,nameAmodB)
#(js) for (var xx=0; xx < X; xx++) {
...
#(begin macro)        boolvX(X,"_divvvvvXabsNameB" + _divvvvvX)
#(js) for (var xx = 0 ; xx < X; xx++) {
    push _divvvvvXabsNameB6_0
    bool
#(js) }
    push _divvvvvXabsNameB6_1
    bool
#(js) }
#(js) for (var xx = 0 ; xx < X-1; xx++) {
    or
...
#(begin macro)    lvar(name + "_c",0)
    push 0
    sbm _supequalvvXName6_c
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_c",0)
#(begin macro)    lvar(name + "_s",0)
    push 0
    sbm _supequalvvXName6_s
#(js) __scope[__scope.length-1]++; 
#(end macro)    lvar(name + "_s",0)
#(js) for (var xx =0 ; xx < X ; xx++) {
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
...
#(end macro)        lvarX(X,"_negNameB" + _subvvvX)
#(begin macro)        pushvX(X,nameB)
    push    _divvvvvXabsNameB6_c
    push    _divvvvvXabsNameB6_s
#(js) for (var xx =0 ; xx < X ; xx++) {
#(js) var xx1; xx1 = X-xx-1; // X-1 to 0
    push    _divvvvvXabsNameB6_1
#(js) }
...
#(begin macro)        addvvvX(X, name, nameA, "_negNameB" + _subvvvX)
    ...
    if      # nameA and nameB are both positive or negative
        push    writeX_AmodB6_s
        pop     _supequalvvXName6_s    # name has same sign of nameA and nameB
        push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
        push    writeX_AmodB6_0
#(begin macro)        addof()
    sbm _addofb85
    sbm _addofa85 - 1
#(begin macro)    scope_begin()
...
#(js) }
            ...
            if  # absA > absB : do  absA-absB with sign of A
                # print("absA > absB\n")
                push    writeX_AmodB6_s
                pop     _supequalvvXName6_s    # name has same sign of nameA 
                push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                push    writeX_AmodB6_0
                swap
...
#(end macro)                    setvX(X,name,0) 
                    ...
                    #print("absA < absB\n")
                    push    _negNameB13_s
                    pop     _supequalvvXName6_s    # name has same sign of nameB
                    push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                    push    _negNameB13_0
                    swap
...
#(begin macro)        addvvvX(X, name, nameA, "_negNameB" + _subvvvX)
    ...
    if      # nameA and nameB are both positive or negative
        push    _subvvXNameB8_s
        pop     writeX_AmodB6_s    # name has same sign of nameA and nameB
        push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
        push    _subvvXNameB8_0
#(begin macro)        addof()
    sbm _addofb91
    sbm _addofa91 - 1
#(begin macro)    scope_begin()
...
#(js) }
            ...
            if  # absA > absB : do  absA-absB with sign of A
                # print("absA > absB\n")
                push    _subvvXNameB8_s
                pop     writeX_AmodB6_s    # name has same sign of nameA 
                push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                push    _subvvXNameB8_0
                swap
...
#(end macro)                    setvX(X,name,0) 
                    ...
                    #print("absA < absB\n")
                    push    _negNameB14_s
                    pop     writeX_AmodB6_s    # name has same sign of nameB
                    push    0
#(js) for (var xx = 0 ; xx < X; xx++) {
                    push    _negNameB14_0
                    swap
...
#(end macro)                    at_reset("_divvvvvX_g" + _divvvvvX) # break while/wend
            ...
            # treat sign of nameAmodB and nameAdivB
            push    _divvvvvXsA6
            pop     writeX_AmodB6_s   # sign of nameAmodB is sign of nameA
            push    _divvvvvXsA6
            push    _divvvvvXsB6
            diff
            if
                push    1
                pop     writeX_AdivB6_s # nameAdivB is negative if sign NameA <> sign nameB
            fi
        else
#(begin macro)            setcvX(X,nameAdivB)
#(begin macro)    at_set(name+"_c",1)
