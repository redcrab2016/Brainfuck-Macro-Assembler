...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# signedX16 macros test' + '\n';
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro var32(name) :declare global 16 bits' + '\n';
_str_main+=__indent() +'# macro lvar32(name) : declare local 16 bits' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro fixsv32(name) : be sure that name is positive if equal to zero' + '\n';
_str_main+=__indent() +'# macro fixs32() : be sure to have sign to zero if 16 bits head of stack value is zero' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro pushv32(name) : push 16 bits name on stack' + '\n';
_str_main+=__indent() +'# macro push32(immValue) : push immediate16 bits value on the stack' + '\n';
_str_main+=__indent() +'# macro pushsv32(name) : push the sign of the 16 bits variable \'name\'' + '\n';
_str_main+=__indent() +'# macro pushcv32(name) : push the carry of the 16 bits variable \'name\'' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro dup32() : duplicate 16bits value on stack' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro popv32(name) : pop the stack to the 16 bits variable \'name\'' + '\n';
_str_main+=__indent() +'# macro popsv32(name) : pop the sign(8 bits 0/1) to the 16 bits variable \'name\'' + '\n';
_str_main+=__indent() +'# macro popcv32(name) : pop the carry(8 bit 0/1) to the 16 bits variable \'name\'' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro drop32() : drop 16 bits value from stack' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro negv32(name) : name = -name' + '\n';
_str_main+=__indent() +'# macro neg32() : 16 bits head of stack = - (16 bits head of stack)' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro absv32(name) : name = abs(name)' + '\n';
_str_main+=__indent() +'# macro abs32() : 16 bits head of stack = abs(16 bits head of stack)' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro setc32() : set 1 to 16 bits head of stack carry' + '\n';
_str_main+=__indent() +'# macro setcv32(name) : set 1 to 16 bits variable \'name\' carry' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro clearc32() : set 0 to 16 bits head of stack carry' + '\n';
_str_main+=__indent() +'# macro clearcv32(name) : set 0 to 16 bits variable \'name\' carry' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro reset32() : reset 16 bits value of the head of stack' + '\n';
_str_main+=__indent() +'# macro resetv32(name) : reset 16 bits variable \'name\'' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro set32(immValue) : set 16 bits value on the head of stack' + '\n';
_str_main+=__indent() +'# macro setv32(name, immValue) : set 16 bits immediate value to a 16 bits variable \'name\'' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro bool32() : same as \'bool\' but with a 16 bits value on stack' + '\n';
_str_main+=__indent() +'# macro boolv32(name) : push on stack the bool(name) 16 bits' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro incv32(name) : name = name +1 (16 bits)' + '\n';
_str_main+=__indent() +'# macro inc32() : 16 bits head of stack value incremented' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro decv32(name) : name-- (16 bits)' + '\n';
_str_main+=__indent() +'# macro dec32() : 16 bits head of stack value decrement' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro addvi32(name, immValue) : name += immediate value' + '\n';
_str_main+=__indent() +'# macro addi32(immValue) : 16 bits head of stack value += immediate value' + '\n';
_str_main+=__indent() +'# macro addvvv32(name, nameA, nameB) : name = nameA + nameB' + '\n';
_str_main+=__indent() +'# macro addvv32(name, nameA) : name += nameA' + '\n';
_str_main+=__indent() +'# macro addv32(nameA) : head stack += nameA' + '\n';
_str_main+=__indent() +'# macro add32() : stack-1 = stack-1 + stack ; stack--' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro subvi32(name, immValue) : name -= immediate value' + '\n';
_str_main+=__indent() +'# macro subi32(immValue) : 16 bits head of stack value -= immediate value' + '\n';
_str_main+=__indent() +'# macro subvvv32(name, nameA, nameB) : name = nameA - nameB' + '\n';
_str_main+=__indent() +'# macro subvv32(name, nameA) : name -= nameA' + '\n';
_str_main+=__indent() +'# macro subv32(nameA) : head stack -= nameA' + '\n';
_str_main+=__indent() +'# macro sub32() : stack-1 = stack-1 - stack ; stack--' + '\n';
...
_str_main+=lvar32("var1");
_str_main+=__indent() +'#(end macro)lvar32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)lvar32("var3")' + '\n';
_str_main+=lvar32("var3");
_str_main+=__indent() +'#(end macro)lvar32("var3")' + '\n';
_str_main+=__indent() +'#(begin macro)lvar32("var4")' + '\n';
_str_main+=lvar32("var4");
_str_main+=__indent() +'#(end macro)lvar32("var4")' + '\n';
_str_main+=__indent() +'#(begin macro)lvar32("var5")' + '\n';
_str_main+=lvar32("var5");
_str_main+=__indent() +'#(end macro)lvar32("var5")' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",0)' + '\n';
_str_main+=setv32("var1",0);
_str_main+=__indent() +'#(end macro)setv32("var1",0)' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var3",65536)' + '\n';
_str_main+=setv32("var3",65536);
_str_main+=__indent() +'#(end macro)setv32("var3",65536)' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var4",-10)' + '\n';
_str_main+=setv32("var4",-10);
_str_main+=__indent() +'#(end macro)setv32("var4",-10)' + '\n';
_str_main+=__indent() +'#(begin macro)addvvv32("var1","var3","var4")' + '\n';
_str_main+=addvvv32("var1","var3","var4");
_str_main+=__indent() +'#(end macro)addvvv32("var1","var3","var4")' + '\n';
_str_main+=__indent() +'#(begin macro)print("65536 + -10:")' + '\n';
_str_main+=print("65536 + -10:");
_str_main+=__indent() +'#(end macro)print("65536 + -10:")' + '\n';
_str_main+=__indent() +'#(begin macro)printhexa32("var1")' + '\n';
_str_main+=printhexa32("var1");
_str_main+=__indent() +'#(end macro)printhexa32("var1")' + '\n';
...
_str_main+=setv32("var1",0);
_str_main+=__indent() +'#(end macro)setv32("var1",0)' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var3",65535)' + '\n';
_str_main+=setv32("var3",65535);
_str_main+=__indent() +'#(end macro)setv32("var3",65535)' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var4",-10)' + '\n';
_str_main+=setv32("var4",-10);
_str_main+=__indent() +'#(end macro)setv32("var4",-10)' + '\n';
_str_main+=__indent() +'#(begin macro)addvvv32("var1","var3","var4")' + '\n';
_str_main+=addvvv32("var1","var3","var4");
_str_main+=__indent() +'#(end macro)addvvv32("var1","var3","var4")' + '\n';
_str_main+=__indent() +'#(begin macro)print("65535 + -10:")' + '\n';
_str_main+=print("65535 + -10:");
_str_main+=__indent() +'#(end macro)print("65535 + -10:")' + '\n';
_str_main+=__indent() +'#(begin macro)printhexa32("var1")' + '\n';
_str_main+=printhexa32("var1");
_str_main+=__indent() +'#(end macro)printhexa32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=setv32("var1",0);
_str_main+=__indent() +'#(end macro)setv32("var1",0)' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var3",-10)' + '\n';
_str_main+=setv32("var3",-10);
_str_main+=__indent() +'#(end macro)setv32("var3",-10)' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var4",65536)' + '\n';
_str_main+=setv32("var4",65536);
_str_main+=__indent() +'#(end macro)setv32("var4",65536)' + '\n';
_str_main+=__indent() +'#(begin macro)addvvv32("var1","var3","var4")' + '\n';
_str_main+=addvvv32("var1","var3","var4");
_str_main+=__indent() +'#(end macro)addvvv32("var1","var3","var4")' + '\n';
_str_main+=__indent() +'#(begin macro)print("-10 + 65536:")' + '\n';
_str_main+=print("-10 + 65536:");
_str_main+=__indent() +'#(end macro)print("-10 + 65536:")' + '\n';
_str_main+=__indent() +'#(begin macro)printhexa32("var1")' + '\n';
_str_main+=printhexa32("var1");
_str_main+=__indent() +'#(end macro)printhexa32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",1)' + '\n';
_str_main+=setv32("var1",1);
_str_main+=__indent() +'#(end macro)setv32("var1",1)' + '\n';
...
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",10)' + '\n';
_str_main+=setv32("var1",10);
_str_main+=__indent() +'#(end macro)setv32("var1",10)' + '\n';
_str_main+=__indent() +'#(begin macro)print("10==")' + '\n';
_str_main+=print("10==");
_str_main+=__indent() +'#(end macro)print("10==")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",100)' + '\n';
_str_main+=setv32("var1",100);
_str_main+=__indent() +'#(end macro)setv32("var1",100)' + '\n';
_str_main+=__indent() +'#(begin macro)print("100==")' + '\n';
_str_main+=print("100==");
_str_main+=__indent() +'#(end macro)print("100==")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",1000)' + '\n';
_str_main+=setv32("var1",1000);
_str_main+=__indent() +'#(end macro)setv32("var1",1000)' + '\n';
_str_main+=__indent() +'#(begin macro)print("1000==")' + '\n';
_str_main+=print("1000==");
_str_main+=__indent() +'#(end macro)print("1000==")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",10000)' + '\n';
_str_main+=setv32("var1",10000);
_str_main+=__indent() +'#(end macro)setv32("var1",10000)' + '\n';
_str_main+=__indent() +'#(begin macro)print("10000==")' + '\n';
_str_main+=print("10000==");
_str_main+=__indent() +'#(end macro)print("10000==")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=setv32("var1",100000);
_str_main+=__indent() +'#(end macro)setv32("var1",100000)' + '\n';
_str_main+=__indent() +'#(begin macro)print("100000==")' + '\n';
_str_main+=print("100000==");
_str_main+=__indent() +'#(end macro)print("100000==")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",1000000)' + '\n';
_str_main+=setv32("var1",1000000);
_str_main+=__indent() +'#(end macro)setv32("var1",1000000)' + '\n';
_str_main+=__indent() +'#(begin macro)print("1000000==")' + '\n';
_str_main+=print("1000000==");
_str_main+=__indent() +'#(end macro)print("1000000==")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=setv32("var3",10);
_str_main+=__indent() +'#(end macro)setv32("var3",10)' + '\n';
_str_main+=__indent() +'#(begin macro)divvvvv32("var4","var5","var1","var3")' + '\n';
_str_main+=divvvvv32("var4","var5","var1","var3");
_str_main+=__indent() +'#(end macro)divvvvv32("var4","var5","var1","var3")' + '\n';
_str_main+=__indent() +'#(begin macro)print("100000 div 10 : 10000 == ")' + '\n';
_str_main+=print("100000 div 10 : 10000 == ");
_str_main+=__indent() +'#(end macro)print("100000 div 10 : 10000 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var4")' + '\n';
_str_main+=write32("var4");
_str_main+=__indent() +'#(end macro)write32("var4")' + '\n';
_str_main+=__indent() +'#(begin macro)print(":")' + '\n';
_str_main+=print(":");
_str_main+=__indent() +'#(end macro)print(":")' + '\n';
_str_main+=__indent() +'#(begin macro)printhexa32("var4")' + '\n';
_str_main+=printhexa32("var4");
_str_main+=__indent() +'#(end macro)printhexa32("var4")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)print("100000 mod 10 : 0 == ")' + '\n';
_str_main+=print("100000 mod 10 : 0 == ");
_str_main+=__indent() +'#(end macro)print("100000 mod 10 : 0 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var5")' + '\n';
_str_main+=write32("var5");
_str_main+=__indent() +'#(end macro)write32("var5")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",65535)' + '\n';
_str_main+=setv32("var1",65535);
_str_main+=__indent() +'#(end macro)setv32("var1",65535)' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var3",10)' + '\n';
_str_main+=setv32("var3",10);
_str_main+=__indent() +'#(end macro)setv32("var3",10)' + '\n';
_str_main+=__indent() +'#(begin macro)divvvvv32("var4","var5","var1","var3")' + '\n';
_str_main+=divvvvv32("var4","var5","var1","var3");
_str_main+=__indent() +'#(end macro)divvvvv32("var4","var5","var1","var3")' + '\n';
_str_main+=__indent() +'#(begin macro)print("65535 div 10 : 6553 == ")' + '\n';
_str_main+=print("65535 div 10 : 6553 == ");
_str_main+=__indent() +'#(end macro)print("65535 div 10 : 6553 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var4")' + '\n';
_str_main+=write32("var4");
_str_main+=__indent() +'#(end macro)write32("var4")' + '\n';
_str_main+=__indent() +'#(begin macro)print(":")' + '\n';
...
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)print("65535 mod 10 : 5 == ")' + '\n';
_str_main+=print("65535 mod 10 : 5 == ");
_str_main+=__indent() +'#(end macro)print("65535 mod 10 : 5 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var5")' + '\n';
_str_main+=write32("var5");
_str_main+=__indent() +'#(end macro)write32("var5")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",65536)' + '\n';
_str_main+=setv32("var1",65536);
_str_main+=__indent() +'#(end macro)setv32("var1",65536)' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var3",10)' + '\n';
_str_main+=setv32("var3",10);
_str_main+=__indent() +'#(end macro)setv32("var3",10)' + '\n';
_str_main+=__indent() +'#(begin macro)divvvvv32("var4","var5","var1","var3")' + '\n';
_str_main+=divvvvv32("var4","var5","var1","var3");
_str_main+=__indent() +'#(end macro)divvvvv32("var4","var5","var1","var3")' + '\n';
_str_main+=__indent() +'#(begin macro)print("65536 div 10 : 6553 == ")' + '\n';
_str_main+=print("65536 div 10 : 6553 == ");
_str_main+=__indent() +'#(end macro)print("65536 div 10 : 6553 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var4")' + '\n';
_str_main+=write32("var4");
_str_main+=__indent() +'#(end macro)write32("var4")' + '\n';
_str_main+=__indent() +'#(begin macro)print(":")' + '\n';
...
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)print("65536 mod 10 : 6 == ")' + '\n';
_str_main+=print("65536 mod 10 : 6 == ");
_str_main+=__indent() +'#(end macro)print("65536 mod 10 : 6 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var5")' + '\n';
_str_main+=write32("var5");
_str_main+=__indent() +'#(end macro)write32("var5")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var1",65545)' + '\n';
_str_main+=setv32("var1",65545);
_str_main+=__indent() +'#(end macro)setv32("var1",65545)' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var3",10)' + '\n';
_str_main+=setv32("var3",10);
_str_main+=__indent() +'#(end macro)setv32("var3",10)' + '\n';
_str_main+=__indent() +'#(begin macro)divvvvv32("var4","var5","var1","var3")' + '\n';
_str_main+=divvvvv32("var4","var5","var1","var3");
_str_main+=__indent() +'#(end macro)divvvvv32("var4","var5","var1","var3")' + '\n';
_str_main+=__indent() +'#(begin macro)print("65545 div 10 : 6554 == ")' + '\n';
_str_main+=print("65545 div 10 : 6554 == ");
_str_main+=__indent() +'#(end macro)print("65545 div 10 : 6554 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var4")' + '\n';
_str_main+=write32("var4");
_str_main+=__indent() +'#(end macro)write32("var4")' + '\n';
_str_main+=__indent() +'#(begin macro)print(":")' + '\n';
...
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)print("65545 mod 10 : 5 == ")' + '\n';
_str_main+=print("65545 mod 10 : 5 == ");
_str_main+=__indent() +'#(end macro)print("65545 mod 10 : 5 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var5")' + '\n';
_str_main+=write32("var5");
_str_main+=__indent() +'#(end macro)write32("var5")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)setv32("var3",100)' + '\n';
_str_main+=setv32("var3",100);
_str_main+=__indent() +'#(end macro)setv32("var3",100)' + '\n';
_str_main+=__indent() +'#(begin macro)push32(10384)' + '\n';
_str_main+=push32(10384);
_str_main+=__indent() +'#(end macro)push32(10384)' + '\n';
_str_main+=__indent() +'#(begin macro)push32(4)' + '\n';
_str_main+=push32(4);
_str_main+=__indent() +'#(end macro)push32(4)' + '\n';
_str_main+=__indent() +'#(begin macro)mul32()' + '\n';
_str_main+=mul32();
_str_main+=__indent() +'#(end macro)mul32()' + '\n';
_str_main+=__indent() +'#(begin macro)popv32("var1")' + '\n';
_str_main+=popv32("var1");
_str_main+=__indent() +'#(end macro)popv32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("10384*4: 41536 == ")' + '\n';
_str_main+=print("10384*4: 41536 == ");
_str_main+=__indent() +'#(end macro)print("10384*4: 41536 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)negv32("var1")' + '\n';
_str_main+=negv32("var1");
_str_main+=__indent() +'#(end macro)negv32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("-41536 == ")' + '\n';
_str_main+=print("-41536 == ");
_str_main+=__indent() +'#(end macro)print("-41536 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)push32(-253)' + '\n';
_str_main+=push32(-253);
_str_main+=__indent() +'#(end macro)push32(-253)' + '\n';
_str_main+=__indent() +'#(begin macro)push32(254)' + '\n';
_str_main+=push32(254);
_str_main+=__indent() +'#(end macro)push32(254)' + '\n';
_str_main+=__indent() +'#(begin macro)mul32()' + '\n';
_str_main+=mul32();
_str_main+=__indent() +'#(end macro)mul32()' + '\n';
_str_main+=__indent() +'#(begin macro)popv32("var1")' + '\n';
_str_main+=popv32("var1");
_str_main+=__indent() +'#(end macro)popv32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("-253*254: -64262 == ")' + '\n';
_str_main+=print("-253*254: -64262 == ");
_str_main+=__indent() +'#(end macro)print("-253*254: -64262 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)push32(-64262)' + '\n';
_str_main+=push32(-64262);
_str_main+=__indent() +'#(end macro)push32(-64262)' + '\n';
_str_main+=__indent() +'#(begin macro)pushv32("var1")' + '\n';
_str_main+=pushv32("var1");
_str_main+=__indent() +'#(end macro)pushv32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)equal32()' + '\n';
_str_main+=equal32();
_str_main+=__indent() +'#(end macro)equal32()' + '\n';
_str_main+=__indent() +'if' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("ok 1\\n")' + '\n';
_str_main+=print("ok 1\n");
_str_main+=__indent() +'#(end macro)print("ok 1\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'else' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("bug 1\\n")' + '\n';
_str_main+=print("bug 1\n");
_str_main+=__indent() +'#(end macro)print("bug 1\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)push32(12)' + '\n';
_str_main+=push32(12);
_str_main+=__indent() +'#(end macro)push32(12)' + '\n';
_str_main+=__indent() +'#(begin macro)pushv32("var1")' + '\n';
_str_main+=pushv32("var1");
_str_main+=__indent() +'#(end macro)pushv32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)equal32()' + '\n';
...
_str_main+=__indent() +'if' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("bug 2\\n")' + '\n';
_str_main+=print("bug 2\n");
_str_main+=__indent() +'#(end macro)print("bug 2\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'else' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("ok 2\\n")' + '\n';
_str_main+=print("ok 2\n");
_str_main+=__indent() +'#(end macro)print("ok 2\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
_str_main+=__indent() +'' + '\n';
...
_str_main+=__indent() +'if' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("bug 3\\n")' + '\n';
_str_main+=print("bug 3\n");
_str_main+=__indent() +'#(end macro)print("bug 3\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'else' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("ok 3\\n")' + '\n';
_str_main+=print("ok 3\n");
_str_main+=__indent() +'#(end macro)print("ok 3\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
...
_str_main+=__indent() +'if' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("ok 4\\n")' + '\n';
_str_main+=print("ok 4\n");
_str_main+=__indent() +'#(end macro)print("ok 4\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'else' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("bug 4\\n")' + '\n';
_str_main+=print("bug 4\n");
_str_main+=__indent() +'#(end macro)print("bug 4\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
...
_str_main+=__indent() +'if' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#push32(12)' + '\n';
_str_main+=__indent() +'#pushv32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)infvv32("var3","var1")' + '\n';
_str_main+=infvv32("var3","var1");
_str_main+=__indent() +'#(end macro)infvv32("var3","var1")' + '\n';
_str_main+=__indent() +'if' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("bug 5\\n")' + '\n';
_str_main+=print("bug 5\n");
_str_main+=__indent() +'#(end macro)print("bug 5\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'else' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("ok 5\\n")' + '\n';
_str_main+=print("ok 5\n");
_str_main+=__indent() +'#(end macro)print("ok 5\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
...
_str_main+=__indent() +'if' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("ok 6\\n")' + '\n';
_str_main+=print("ok 6\n");
_str_main+=__indent() +'#(end macro)print("ok 6\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'else' + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("bug 6\\n")' + '\n';
_str_main+=print("bug 6\n");
_str_main+=__indent() +'#(end macro)print("bug 6\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'#(begin macro)incv32("var1")' + '\n';
_str_main+=incv32("var1");
_str_main+=__indent() +'#(end macro)incv32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("-64261 == ")' + '\n';
_str_main+=print("-64261 == ");
_str_main+=__indent() +'#(end macro)print("-64261 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var1")' + '\n';
_str_main+=write32("var1");
_str_main+=__indent() +'#(end macro)write32("var1")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro divvvvv32(nameAdivB, nameAmodB, nameA, nameB) : nameAdivB = nameA div nameB ; nameAmodB = nameA mod nameB' + '\n';
_str_main+=__indent() +'# macro divvv32(nameA, nameB) : Push 2 16 bits values  : stack-1 = nameA mod nameB ; stack = nameA div nameB' + '\n';
_str_main+=__indent() +'# macro div32() : stack-1 == A , stack == B ; stack-1 = A mod B , stack = A div B' + '\n';
_str_main+=__indent() +'#(begin macro)scope_begin()' + '\n';
_str_main+=scope_begin();
_str_main+=__indent() +'#(end macro)scope_begin()' + '\n';
_str_main+=__indent() +'#(begin macro)lvar32("var2")' + '\n';
_str_main+=lvar32("var2");
_str_main+=__indent() +'#(end macro)lvar32("var2")' + '\n';
_str_main+=__indent() +'#(begin macro)push32(10384)' + '\n';
_str_main+=push32(10384);
_str_main+=__indent() +'#(end macro)push32(10384)' + '\n';
_str_main+=__indent() +'#(begin macro)push32(-512)' + '\n';
_str_main+=push32(-512);
_str_main+=__indent() +'#(end macro)push32(-512)' + '\n';
_str_main+=__indent() +'#(begin macro)div32()' + '\n';
_str_main+=div32();
_str_main+=__indent() +'#(end macro)div32()' + '\n';
_str_main+=__indent() +'#(begin macro)print("10384 div -512: -20 == ")' + '\n';
_str_main+=print("10384 div -512: -20 == ");
_str_main+=__indent() +'#(end macro)print("10384 div -512: -20 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)popv32("var2")' + '\n';
_str_main+=popv32("var2");
_str_main+=__indent() +'#(end macro)popv32("var2")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var2")' + '\n';
_str_main+=write32("var2");
_str_main+=__indent() +'#(end macro)write32("var2")' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
_str_main+=print("\n");
_str_main+=__indent() +'#(end macro)print("\\n")' + '\n';
_str_main+=__indent() +'#(begin macro)print("10384 mod -512: 144 == ")' + '\n';
_str_main+=print("10384 mod -512: 144 == ");
_str_main+=__indent() +'#(end macro)print("10384 mod -512: 144 == ")' + '\n';
_str_main+=__indent() +'#(begin macro)popv32("var2")' + '\n';
_str_main+=popv32("var2");
_str_main+=__indent() +'#(end macro)popv32("var2")' + '\n';
_str_main+=__indent() +'#(begin macro)write32("var2")' + '\n';
...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro equalvv32(nameA, nameB) : push 1 if NameA == NameB , push 0 otherwise' + '\n';
_str_main+=__indent() +'# macro equal32() : same as "equal" but with 16 bits value in stack' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro diffvv32(nameA, nameB) : push 1 if Name != NameB , push 0 otherwise' + '\n';
_str_main+=__indent() +'# macro diff32() : same as "diff" but with 16 bits value in stack' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro supvv32(nameA , nameB) : push 1 if nameA > nameB push 0 otherwise' + '\n';
_str_main+=__indent() +'# macro sup32() : push 1 if stack-1 > stack, push 0 otherwise : after dropped 2 16 bits value from stack' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro supequalvv32(nameA, nameB) : push 1 if nameA >= nameB push 0 otherwise' + '\n';
_str_main+=__indent() +'# macro supequal32() : push 1 if stack-1 >= stack , push 0 otherwise : after dropped 2 16 bits value from stack' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro infvv32(nameA, nameB) : push 1 if nameA < nameB push 0 otherwise' + '\n';
_str_main+=__indent() +'# macro inf32() : push 1 if stack-1 < stack, push 0 otherwise : after dropped 2 16 bits value from stack' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro infequalvv32(nameA, nameB) : push 1 if nameA <= nameB push 0 otherwise' + '\n';
_str_main+=__indent() +'# macro infequal32() : push 1 if stack-1 <= stack, push 0 otherwise : after dropped 2 16 bits value from stack' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro write32(name) : print out the decimal value (signed)' + '\n';
_str_main+=__indent() +'# macro printhexa32(name) : print the 16 bit variable in hexadecimal' + '\n';
return _str_main;
}
_main();
