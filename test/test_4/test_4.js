...
_str_main+=__indent() +'# Test 4 #@(main@1)'+ __context() + '\n';
...
_str_main+=__indent() +'#(begin include)../../samples/include/fpnumber.inc' + '\n';
...
_str_main+=__indent() +'#(end include)../../samples/include/fpnumber.inc' + '\n';
_str_main+=__indent() +' #@(main@4)'+ __context() + '\n';
_str_main+=__indent() +'#(begin macro)print("Fix point number macro test.\\n\\n")' + '\n';
__context__.push('(main@5)');
_str_main+=print("Fix point number macro test.\n\n");
__context__.pop();
_str_main+=__indent() +'#(end macro)print("Fix point number macro test.\\n\\n")' + '\n';
_str_main+=__indent() +' #@(main@6)'+ __context() + '\n';
_str_main+=__indent() +'# 8.16 fixed number #@(main@7)'+ __context() + '\n';
_str_main+=__indent() +'## 8 = 1*8 bits #@(main@8)'+ __context() + '\n';
var FP_I;FP_I='1'; FP_I=(isNaN(FP_I*1))?(FP_I):(FP_I*1); 
_str_main+=__indent() +'## 16 = 2*8 bits #@(main@10)'+ __context() + '\n';
var FP_P;FP_P='2'; FP_P=(isNaN(FP_P*1))?(FP_P):(FP_P*1); 
_str_main+=__indent() +'# FP_I + FP_P #@(main@12)'+ __context() + '\n';
_str_main+=__indent() +'## 1+2 = 3 : 24 bits #@(main@13)'+ __context() + '\n';
var FP;FP='3'; FP=(isNaN(FP*1))?(FP):(FP*1); 
_str_main+=__indent() +' #@(main@15)'+ __context() + '\n';
_str_main+=__indent() +'#(begin macro)varX    ' + (FP) + ',   var1' + '\n';
__context__.push('(main@16)');
_str_main+=varX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var1')*1))?('var1'):(('var1')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)varX    ' + (FP) + ',   var1' + '\n';
_str_main+=__indent() +'#(begin macro)varX    ' + (FP) + ',   var2' + '\n';
__context__.push('(main@17)');
_str_main+=varX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var2')*1))?('var2'):(('var2')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)varX    ' + (FP) + ',   var2' + '\n';
_str_main+=__indent() +'#(begin macro)varX    2,      var3' + '\n';
__context__.push('(main@18)');
_str_main+=varX(((isNaN(('2')*1))?('2'):(('2')*1)),((isNaN(('var3')*1))?('var3'):(('var3')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)varX    2,      var3' + '\n';
_str_main+=__indent() +'#(begin macro)varX    ' + (FP*2) + ', var4' + '\n';
__context__.push('(main@19)');
_str_main+=varX(((isNaN(('' + (FP*2) + '')*1))?('' + (FP*2) + ''):(('' + (FP*2) + '')*1)),((isNaN(('var4')*1))?('var4'):(('var4')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)varX    ' + (FP*2) + ', var4' + '\n';
_str_main+=__indent() +' #@(main@20)'+ __context() + '\n';
_str_main+=__indent() +'#(begin macro)print("10.5 hexa=")' + '\n';
__context__.push('(main@21)');
_str_main+=print("10.5 hexa=");
__context__.pop();
_str_main+=__indent() +'#(end macro)print("10.5 hexa=")' + '\n';
_str_main+=__indent() +'#(begin macro)pushFP  ' + (FP_I) + ', ' + (FP_P) + ', 10.5' + '\n';
__context__.push('(main@22)');
_str_main+=pushFP(((isNaN(('' + (FP_I) + '')*1))?('' + (FP_I) + ''):(('' + (FP_I) + '')*1)),((isNaN(('' + (FP_P) + '')*1))?('' + (FP_P) + ''):(('' + (FP_P) + '')*1)),((isNaN(('10.5')*1))?('10.5'):(('10.5')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)pushFP  ' + (FP_I) + ', ' + (FP_P) + ', 10.5' + '\n';
_str_main+=__indent() +'#(begin macro)popvX   ' + (FP) + ',   var1' + '\n';
__context__.push('(main@23)');
_str_main+=popvX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var1')*1))?('var1'):(('var1')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)popvX   ' + (FP) + ',   var1' + '\n';
_str_main+=__indent() +'#(begin macro)printhexaX  ' + (FP) + ',   var1' + '\n';
__context__.push('(main@24)');
_str_main+=printhexaX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var1')*1))?('var1'):(('var1')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)printhexaX  ' + (FP) + ',   var1' + '\n';
...
_str_main+=__indent() +'#(begin macro)print("10.5 cast from 8,16 to 8,8=")' + '\n';
__context__.push('(main@28)');
_str_main+=print("10.5 cast from 8,16 to 8,8=");
__context__.pop();
_str_main+=__indent() +'#(end macro)print("10.5 cast from 8,16 to 8,8=")' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX  ' + (FP) + ',   var1' + '\n';
__context__.push('(main@29)');
_str_main+=pushvX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var1')*1))?('var1'):(('var1')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)pushvX  ' + (FP) + ',   var1' + '\n';
_str_main+=__indent() +'#(begin macro)castFP  ' + (FP_I) + ', ' + (FP_P) + ', 1,  1' + '\n';
__context__.push('(main@30)');
_str_main+=castFP(((isNaN(('' + (FP_I) + '')*1))?('' + (FP_I) + ''):(('' + (FP_I) + '')*1)),((isNaN(('' + (FP_P) + '')*1))?('' + (FP_P) + ''):(('' + (FP_P) + '')*1)),((isNaN(('1')*1))?('1'):(('1')*1)),((isNaN(('1')*1))?('1'):(('1')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)castFP  ' + (FP_I) + ', ' + (FP_P) + ', 1,  1' + '\n';
_str_main+=__indent() +'#(begin macro)popvX   2,      var3' + '\n';
__context__.push('(main@31)');
_str_main+=popvX(((isNaN(('2')*1))?('2'):(('2')*1)),((isNaN(('var3')*1))?('var3'):(('var3')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)popvX   2,      var3' + '\n';
_str_main+=__indent() +'#(begin macro)printhexaX  2,  var3' + '\n';
__context__.push('(main@32)');
_str_main+=printhexaX(((isNaN(('2')*1))?('2'):(('2')*1)),((isNaN(('var3')*1))?('var3'):(('var3')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)printhexaX  2,  var3' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'#(begin macro)print("10.5 cast from 8,16 to 16,32=")' + '\n';
__context__.push('(main@35)');
_str_main+=print("10.5 cast from 8,16 to 16,32=");
__context__.pop();
_str_main+=__indent() +'#(end macro)print("10.5 cast from 8,16 to 16,32=")' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX  ' + (FP) + ',   var1' + '\n';
__context__.push('(main@36)');
_str_main+=pushvX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var1')*1))?('var1'):(('var1')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)pushvX  ' + (FP) + ',   var1' + '\n';
_str_main+=__indent() +'#(begin macro)castFP  ' + (FP_I) + ', ' + (FP_P) + ', ' + (FP_I*2) + ',  ' + (FP_P*2) + '' + '\n';
__context__.push('(main@37)');
_str_main+=castFP(((isNaN(('' + (FP_I) + '')*1))?('' + (FP_I) + ''):(('' + (FP_I) + '')*1)),((isNaN(('' + (FP_P) + '')*1))?('' + (FP_P) + ''):(('' + (FP_P) + '')*1)),((isNaN(('' + (FP_I*2) + '')*1))?('' + (FP_I*2) + ''):(('' + (FP_I*2) + '')*1)),((isNaN(('' + (FP_P*2) + '')*1))?('' + (FP_P*2) + ''):(('' + (FP_P*2) + '')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)castFP  ' + (FP_I) + ', ' + (FP_P) + ', ' + (FP_I*2) + ',  ' + (FP_P*2) + '' + '\n';
_str_main+=__indent() +'#(begin macro)popvX   ' + (FP*2) + ',      var4' + '\n';
__context__.push('(main@38)');
_str_main+=popvX(((isNaN(('' + (FP*2) + '')*1))?('' + (FP*2) + ''):(('' + (FP*2) + '')*1)),((isNaN(('var4')*1))?('var4'):(('var4')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)popvX   ' + (FP*2) + ',      var4' + '\n';
_str_main+=__indent() +'#(begin macro)printhexaX  ' + (FP*2) + ',  var4' + '\n';
__context__.push('(main@39)');
_str_main+=printhexaX(((isNaN(('' + (FP*2) + '')*1))?('' + (FP*2) + ''):(('' + (FP*2) + '')*1)),((isNaN(('var4')*1))?('var4'):(('var4')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)printhexaX  ' + (FP*2) + ',  var4' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'#(begin macro)print("10.5 * 2 hexa=")' + '\n';
__context__.push('(main@43)');
_str_main+=print("10.5 * 2 hexa=");
__context__.pop();
_str_main+=__indent() +'#(end macro)print("10.5 * 2 hexa=")' + '\n';
_str_main+=__indent() +'#(begin macro)pushvX  ' + (FP) + ',   var1' + '\n';
...
_str_main+=__indent() +'#(begin macro)popvX   ' + (FP) + ',   var2' + '\n';
__context__.push('(main@47)');
_str_main+=popvX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var2')*1))?('var2'):(('var2')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)popvX   ' + (FP) + ',   var2' + '\n';
_str_main+=__indent() +'#(begin macro)printhexaX  ' + (FP) + ',   var2' + '\n';
__context__.push('(main@48)');
_str_main+=printhexaX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var2')*1))?('var2'):(('var2')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)printhexaX  ' + (FP) + ',   var2' + '\n';
_str_main+=__indent() +'#(begin macro)print("\\n")' + '\n';
...
_str_main+=__indent() +'#(begin macro)setvX   ' + (FP) + ',   var2,   21.0' + '\n';
__context__.push('(main@51)');
_str_main+=setvX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var2')*1))?('var2'):(('var2')*1)),((isNaN(('21.0')*1))?('21.0'):(('21.0')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)setvX   ' + (FP) + ',   var2,   21.0' + '\n';
_str_main+=__indent() +'#(begin macro)setvX   ' + (FP) + ',   var1,   4.5' + '\n';
__context__.push('(main@52)');
_str_main+=setvX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var1')*1))?('var1'):(('var1')*1)),((isNaN(('4.5')*1))?('4.5'):(('4.5')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)setvX   ' + (FP) + ',   var1,   4.5' + '\n';
_str_main+=__indent() +'#(begin macro)print(" 21 < 4.5:")' + '\n';
__context__.push('(main@53)');
_str_main+=print(" 21 < 4.5:");
__context__.pop();
_str_main+=__indent() +'#(end macro)print(" 21 < 4.5:")' + '\n';
_str_main+=__indent() +'#(begin macro)infvvX  ' + (FP) + ',   var2,   var1' + '\n';
__context__.push('(main@54)');
_str_main+=infvvX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var2')*1))?('var2'):(('var2')*1)),((isNaN(('var1')*1))?('var1'):(('var1')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)infvvX  ' + (FP) + ',   var2,   var1' + '\n';
_str_main+=__indent() +'if #@(main@55)'+ __context() + '\n';
__blockLevel__++;
...
__blockLevel__--;
_str_main+=__indent() +'else #@(main@57)'+ __context() + '\n';
__blockLevel__++;
...
__blockLevel__--;
_str_main+=__indent() +'fi #@(main@59)'+ __context() + '\n';
_str_main+=__indent() +'#(begin macro)print(" 4.5 < 21:")' + '\n';
__context__.push('(main@60)');
_str_main+=print(" 4.5 < 21:");
__context__.pop();
_str_main+=__indent() +'#(end macro)print(" 4.5 < 21:")' + '\n';
_str_main+=__indent() +'#(begin macro)infvvX  ' + (FP) + ',   var1,   var2' + '\n';
__context__.push('(main@61)');
_str_main+=infvvX(((isNaN(('' + (FP) + '')*1))?('' + (FP) + ''):(('' + (FP) + '')*1)),((isNaN(('var1')*1))?('var1'):(('var1')*1)),((isNaN(('var2')*1))?('var2'):(('var2')*1)));
__context__.pop();
_str_main+=__indent() +'#(end macro)infvvX  ' + (FP) + ',   var1,   var2' + '\n';
_str_main+=__indent() +'if #@(main@62)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("Ok\\n")' + '\n';
...
_str_main+=__indent() +'#(end macro)print("Ok\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'else #@(main@64)'+ __context() + '\n';
__blockLevel__++;
_str_main+=__indent() +'#(begin macro)print("Bug\\n")' + '\n';
...
_str_main+=__indent() +'#(end macro)print("Bug\\n")' + '\n';
__blockLevel__--;
_str_main+=__indent() +'fi #@(main@66)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@67)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@68)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@69)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@70)'+ __context() + '\n';
_str_main+=__indent() +' #@(main@71)'+ __context() + '\n';
return _str_main;
}
_main();
