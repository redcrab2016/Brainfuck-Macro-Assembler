...
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# basic macros test' + '\n';
...
_str_main+=__indent() +'# macro at_set(a,b) : a = b (immediate)' + '\n';
_str_main+=__indent() +'' + '\n';
_str_main+=__indent() +'# macro write(a) : print out  variable/immediate 8 bits \'a\'' + '\n';
_str_main+=__indent() +'# macro divide(a,b,d,r) : d = a div b ; r = a mod b : 8 bits var or immediate \'a\' and \'b\'' + '\n';
_str_main+=__indent() +'# macro left_rewind(array)' + '\n';
_str_main+=__indent() +'# macro right_rewind(array)' + '\n';
