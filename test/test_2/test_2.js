...
_str_main+='#(end macro)    print("  b = 20 : 14 == ")' + '\n';
_str_main+='    push    b' + '\n';
_str_main+='#(begin macro)    popout8hexa()' + '\n';
_str_main+=popout8hexa();
_str_main+='#(end macro)    popout8hexa()' + '\n';
...
_str_main+='#(end macro)    print("  c = 30 : 1E == ")' + '\n';
_str_main+='    push    c' + '\n';
_str_main+='#(begin macro)    popout8hexa()' + '\n';
_str_main+=popout8hexa();
_str_main+='#(end macro)    popout8hexa()' + '\n';
...
_str_main+='#(end macro)    print("  d = 40 : 28 == ")' + '\n';
_str_main+='    push    d' + '\n';
_str_main+='#(begin macro)    popout8hexa()' + '\n';
_str_main+=popout8hexa();
_str_main+='#(end macro)    popout8hexa()' + '\n';
...
_str_main+='#(end macro)    print("  f = 20 : 14 == ")' + '\n';
_str_main+='    push    f' + '\n';
_str_main+='#(begin macro)    popout8hexa()' + '\n';
_str_main+=popout8hexa();
_str_main+='#(end macro)    popout8hexa()' + '\n';
...
_str_main+='#(end macro)    print("   a diff b is true; ")' + '\n';
_str_main+='#(begin macro)    if_diff("a","b")' + '\n';
_str_main+=if_diff("a","b");
_str_main+='#(end macro)    if_diff("a","b")' + '\n';
...
_str_main+='#(end macro)    print("   b diff f is false; ")' + '\n';
_str_main+='#(begin macro)    if_diff("b","f")' + '\n';
_str_main+=if_diff("b","f");
_str_main+='#(end macro)    if_diff("b","f")' + '\n';
_str_main+='#(begin macro)        print ("BUG\\n")' + '\n';
_str_main+=print("BUG\n");
_str_main+='#(end macro)        print ("BUG\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   a equal b is false; ")' + '\n';
_str_main+='#(begin macro)    if_equal("a","b")' + '\n';
_str_main+=if_equal("a","b");
_str_main+='#(end macro)    if_equal("a","b")' + '\n';
_str_main+='#(begin macro)        print ("BUG\\n")' + '\n';
_str_main+=print("BUG\n");
_str_main+='#(end macro)        print ("BUG\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   b equal f is true; ")' + '\n';
_str_main+='#(begin macro)    if_equal("b","f")' + '\n';
_str_main+=if_equal("b","f");
_str_main+='#(end macro)    if_equal("b","f")' + '\n';
_str_main+='#(begin macro)        print ("OK\\n")' + '\n';
_str_main+=print("OK\n");
_str_main+='#(end macro)        print ("OK\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   a sup b is false; ")' + '\n';
_str_main+='#(begin macro)    if_sup("a","b")' + '\n';
_str_main+=if_sup("a","b");
_str_main+='#(end macro)    if_sup("a","b")' + '\n';
_str_main+='#(begin macro)        print ("BUG\\n")' + '\n';
_str_main+=print("BUG\n");
_str_main+='#(end macro)        print ("BUG\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   c sup b is true; ")' + '\n';
_str_main+='#(begin macro)    if_sup("c","b")' + '\n';
_str_main+=if_sup("c","b");
_str_main+='#(end macro)    if_sup("c","b")' + '\n';
_str_main+='#(begin macro)        print ("OK\\n")' + '\n';
_str_main+=print("OK\n");
_str_main+='#(end macro)        print ("OK\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   f sup b is false; ")' + '\n';
_str_main+='#(begin macro)    if_sup("f","b")' + '\n';
_str_main+=if_sup("f","b");
_str_main+='#(end macro)    if_sup("f","b")' + '\n';
_str_main+='#(begin macro)        print ("BUG\\n")' + '\n';
_str_main+=print("BUG\n");
_str_main+='#(end macro)        print ("BUG\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   a inf b is true; ")' + '\n';
_str_main+='#(begin macro)    if_inf("a","b")' + '\n';
_str_main+=if_inf("a","b");
_str_main+='#(end macro)    if_inf("a","b")' + '\n';
_str_main+='#(begin macro)        print ("OK\\n")' + '\n';
_str_main+=print("OK\n");
_str_main+='#(end macro)        print ("OK\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   c inf b is false; ")' + '\n';
_str_main+='#(begin macro)    if_inf("c","b")' + '\n';
_str_main+=if_inf("c","b");
_str_main+='#(end macro)    if_inf("c","b")' + '\n';
_str_main+='#(begin macro)        print ("BUG\\n")' + '\n';
_str_main+=print("BUG\n");
_str_main+='#(end macro)        print ("BUG\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   f inf b is false; ")' + '\n';
_str_main+='#(begin macro)    if_inf("f","b")' + '\n';
_str_main+=if_inf("f","b");
_str_main+='#(end macro)    if_inf("f","b")' + '\n';
_str_main+='#(begin macro)        print ("BUG\\n")' + '\n';
_str_main+=print("BUG\n");
_str_main+='#(end macro)        print ("BUG\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   a supequal b is false; ")' + '\n';
_str_main+='#(begin macro)    if_supequal("a","b")' + '\n';
_str_main+=if_supequal("a","b");
_str_main+='#(end macro)    if_supequal("a","b")' + '\n';
_str_main+='#(begin macro)        print ("BUG\\n")' + '\n';
_str_main+=print("BUG\n");
_str_main+='#(end macro)        print ("BUG\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   c supequal b is true; ")' + '\n';
_str_main+='#(begin macro)    if_supequal("c","b")' + '\n';
_str_main+=if_supequal("c","b");
_str_main+='#(end macro)    if_supequal("c","b")' + '\n';
_str_main+='#(begin macro)        print ("OK\\n")' + '\n';
_str_main+=print("OK\n");
_str_main+='#(end macro)        print ("OK\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   f supequal b is true; ")' + '\n';
_str_main+='#(begin macro)    if_supequal("f","b")' + '\n';
_str_main+=if_supequal("f","b");
_str_main+='#(end macro)    if_supequal("f","b")' + '\n';
_str_main+='#(begin macro)        print ("OK\\n")' + '\n';
_str_main+=print("OK\n");
_str_main+='#(end macro)        print ("OK\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   a infequal b is true; ")' + '\n';
_str_main+='#(begin macro)    if_infequal("a","b")' + '\n';
_str_main+=if_infequal("a","b");
_str_main+='#(end macro)    if_infequal("a","b")' + '\n';
_str_main+='#(begin macro)        print ("OK\\n")' + '\n';
_str_main+=print("OK\n");
_str_main+='#(end macro)        print ("OK\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   c infequal b is false; ")' + '\n';
_str_main+='#(begin macro)    if_infequal("c","b")' + '\n';
_str_main+=if_infequal("c","b");
_str_main+='#(end macro)    if_infequal("c","b")' + '\n';
_str_main+='#(begin macro)        print ("BUG\\n")' + '\n';
_str_main+=print("BUG\n");
_str_main+='#(end macro)        print ("BUG\\n")' + '\n';
_str_main+='    else' + '\n';
...
_str_main+='#(end macro)    print("   f infequal b is true; ")' + '\n';
_str_main+='#(begin macro)    if_infequal("f","b")' + '\n';
_str_main+=if_infequal("f","b");
_str_main+='#(end macro)    if_infequal("f","b")' + '\n';
_str_main+='#(begin macro)        print ("OK\\n")' + '\n';
_str_main+=print("OK\n");
_str_main+='#(end macro)        print ("OK\\n")' + '\n';
_str_main+='    else' + '\n';
