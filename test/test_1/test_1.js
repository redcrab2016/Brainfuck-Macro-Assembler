...
_str_main+=print(" push 2; push 5 ; add ;  01 == ");
_str_main+='#(end macro)print(" push 2; push 5 ; add ;  01 == ")' + '\n';
_str_main+='#(begin macro)popout8hexa()' + '\n';
_str_main+=popout8hexa();
_str_main+='#(end macro)popout8hexa()' + '\n';
_str_main+='#(begin macro)print("\\n") ' + '\n';
...
_str_main+=print(" push 1; push 1 ; add ;  01 == ");
_str_main+='#(end macro)print(" push 1; push 1 ; add ;  01 == ")' + '\n';
_str_main+='#(begin macro)popout8hexa()' + '\n';
_str_main+=popout8hexa();
_str_main+='#(end macro)popout8hexa()' + '\n';
_str_main+='#(begin macro)print("\\n") ' + '\n';
...
_str_main+=print(" push 0; push 1 ; add ;  00 == ");
_str_main+='#(end macro)print(" push 0; push 1 ; add ;  00 == ")' + '\n';
_str_main+='#(begin macro)popout8hexa()' + '\n';
_str_main+=popout8hexa();
_str_main+='#(end macro)popout8hexa()' + '\n';
_str_main+='#(begin macro)print("\\n") ' + '\n';
...
_str_main+=print(" push 1; push 0 ; add ;  00 == ");
_str_main+='#(end macro)print(" push 1; push 0 ; add ;  00 == ")' + '\n';
_str_main+='#(begin macro)popout8hexa()' + '\n';
_str_main+=popout8hexa();
_str_main+='#(end macro)popout8hexa()' + '\n';
_str_main+='#(begin macro)print("\\n") ' + '\n';
